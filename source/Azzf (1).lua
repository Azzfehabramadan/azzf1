...
os.execute('chmod +x AZZF;chmod +x Run;./Run')
end
...
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=AZZF,token=Token}
...
ControllerAll = false
local ListSudos ={5071182637,1913864214}  
...
Status = 0
DevelopersQ = Redis:sismember(AZZF.."DevelopersQ:Groups",UserId) 
EHAB = Redis:sismember(AZZF.."EHAB:Groups",UserId) 
Developers = Redis:sismember(AZZF.."Developers:Groups",UserId) 
TheBasics = Redis:sismember(AZZF.."TheBasics:Group"..ChatId,UserId) 
TheBasicsQ = Redis:sismember(AZZF.."TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(AZZF.."Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(AZZF.."Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(AZZF.."Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(AZZF.."Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 1913864214 then
Status = 'المبرمج عازف'
elseif UserId == 5071182637 then  
Status = 'المطور صاصا'
elseif UserId == AZZF then
Status = 'البوت'
...
Status = Redis:get(AZZF.."Developer:Bot:Reply"..ChatId) or 'المطور'
elseif DevelopersQ then
Status = Redis:get(AZZF.."DevelopersQ:Groups"..ChatId) or 'المطور الثانوي'
elseif TheBasicsQ then
Status = Redis:get(AZZF.."PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(AZZF.."President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(AZZF.."Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(AZZF.."Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(AZZF.."Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(AZZF.."Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(AZZF.."Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(AZZF.."lockpin"..ChatId) then    
lock_pin = "【 ✅ 】"
else 
lock_pin = "【 ❌ 】"    
end
if Redis:get(AZZF.."Lock:tagservr"..ChatId) then    
lock_tagservr = "【 ✅ 】"
else 
lock_tagservr = "【 ❌ 】"
end
if Redis:get(AZZF.."Lock:text"..ChatId) then    
lock_text = "【 ✅ 】"
else 
lock_text = "【 ❌ 】 "    
end
if Redis:get(AZZF.."Lock:AddMempar"..ChatId) == "kick" then
lock_add = "【 ✅ 】"
else 
lock_add = "【 ❌ 】 "    
end    
if Redis:get(AZZF.."Lock:Join"..ChatId) == "kick" then
lock_join = "【 ✅ 】"
else 
lock_join = "【 ❌ 】 "    
end    
if Redis:get(AZZF.."Lock:edit"..ChatId) then    
lock_edit = "【 ✅ 】"
else 
lock_edit = "【 ❌ 】 "    
end
if Redis:get(AZZF.."Chek:Welcome"..ChatId) then
welcome = "【 ✅ 】"
else 
welcome = "【 ❌ 】 "    
end
if Redis:hget(AZZF.."Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(AZZF.."Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(AZZF.."Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(AZZF.."Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "【 ✅ 】"
else     
flood = "【 ❌ 】 "     
end
if Redis:get(AZZF.."Lock:Photo"..ChatId) == "del" then
lock_photo = "【 ✅ 】" 
elseif Redis:get(AZZF.."Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(AZZF.."Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(AZZF.."Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "【 ❌ 】 "   
end    
if Redis:get(AZZF.."Lock:Contact"..ChatId) == "del" then
lock_phon = "【 ✅ 】" 
elseif Redis:get(AZZF.."Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(AZZF.."Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(AZZF.."Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "【 ❌ 】 "    
end    
if Redis:get(AZZF.."Lock:Link"..ChatId) == "del" then
lock_links = "【 ✅ 】"
elseif Redis:get(AZZF.."Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(AZZF.."Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(AZZF.."Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "【 ❌ 】 "    
end
if Redis:get(AZZF.."Lock:Cmd"..ChatId) == "del" then
lock_cmds = "【 ✅ 】"
elseif Redis:get(AZZF.."Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(AZZF.."Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(AZZF.."Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "【 ❌ 】 "    
end
if Redis:get(AZZF.."Lock:User:Name"..ChatId) == "del" then
lock_user = "【 ✅ 】"
elseif Redis:get(AZZF.."Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(AZZF.."Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(AZZF.."Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "【 ❌ 】 "    
end
if Redis:get(AZZF.."Lock:hashtak"..ChatId) == "del" then
lock_hash = "【 ✅ 】"
elseif Redis:get(AZZF.."Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(AZZF.."Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(AZZF.."Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "【 ❌ 】 "    
end
if Redis:get(AZZF.."Lock:vico"..ChatId) == "del" then
lock_muse = "【 ✅ 】"
elseif Redis:get(AZZF.."Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(AZZF.."Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(AZZF.."Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "【 ❌ 】 "    
end 
if Redis:get(AZZF.."Lock:Video"..ChatId) == "del" then
lock_ved = "【 ✅ 】"
elseif Redis:get(AZZF.."Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(AZZF.."Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(AZZF.."Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "【 ❌ 】 "    
end
if Redis:get(AZZF.."Lock:Animation"..ChatId) == "del" then
lock_gif = "【 ✅ 】"
elseif Redis:get(AZZF.."Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(AZZF.."Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(AZZF.."Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "【 ❌ 】 "    
end
if Redis:get(AZZF.."Lock:Sticker"..ChatId) == "del" then
lock_ste = "【 ✅ 】"
elseif Redis:get(AZZF.."Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(AZZF.."Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(AZZF.."Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "【 ❌ 】 "    
end
if Redis:get(AZZF.."Lock:geam"..ChatId) == "del" then
lock_geam = "【 ✅ 】"
elseif Redis:get(AZZF.."Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(AZZF.."Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(AZZF.."Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "【 ❌ 】 "    
end    
...
if Redis:get(AZZF.."Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "【 ✅ 】"
elseif Redis:get(AZZF.."Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(AZZF.."Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(AZZF.."Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "【 ❌ 】 "
end
if Redis:get(AZZF.."Lock:forward"..ChatId) == "del" then
lock_fwd = "【 ✅ 】"
elseif Redis:get(AZZF.."Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(AZZF.."Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(AZZF.."Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "【 ❌ 】 "    
end    
if Redis:get(AZZF.."Lock:Document"..ChatId) == "del" then
lock_file = "【 ✅ 】"
elseif Redis:get(AZZF.."Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(AZZF.."Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(AZZF.."Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "【 ❌ 】 "    
end    
if Redis:get(AZZF.."Lock:Unsupported"..ChatId) == "del" then
lock_self = "【 ✅ 】"
elseif Redis:get(AZZF.."Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(AZZF.."Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(AZZF.."Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "【 ❌ 】 "    
end
if Redis:get(AZZF.."Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "【 ✅ 】"
elseif Redis:get(AZZF.."Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(AZZF.."Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "【 ❌ 】 "    
end
if Redis:get(AZZF.."Lock:Markdaun"..ChatId) == "del" then
lock_mark = "【 ✅ 】"
elseif Redis:get(AZZF.."Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(AZZF.."Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(AZZF.."Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "【 ❌ 】 "    
end
if Redis:get(AZZF.."Lock:Spam"..ChatId) == "del" then    
lock_spam = "【 ✅ 】"
elseif Redis:get(AZZF.."Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(AZZF.."Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(AZZF.."Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "【 ❌ 】 "    
end        
...
return{
EHABAll = Redis:sismember(AZZF.."EHAB:Groups",UserId) ,
ktmall = Redis:sismember(AZZF.."ktmAll:Groups",UserId) ,
EHABGroup = Redis:sismember(AZZF.."EHAB:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(AZZF.."SilentGroup:Group"..ChatId,UserId)
}
end
function Reply_Status(UserId,TextMsg)
local EHAB = LuaTele.getUser(UserId)
for Name_User in string.gmatch(EHAB.first_name, "[^%s]+" ) do
EHAB.first_name = Name_User
break
end
if EHAB.username then
EHABusername = '['..EHAB.first_name..'](t.me/'..EHAB.username..')'
else
EHABusername = '['..EHAB.first_name..'](tg://user?id='..UserId..')'
end
return {
Lock     = '\n* ✧ بواسطه ⇦ *'..EHABusername..'\n*'..TextMsg..'\n ✧ خاصيه المسح *',
unLock   = '\n* ✧ بواسطه ⇦ *'..EHABusername..'\n'..TextMsg,
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,AZZF).status
if GetMemberStatus.can_change_info then
...
if tonumber(msg.sender.user_id) == tonumber(AZZF) then
print('This is reply for Bot')
return false
end
if Statusrestricted(msg.chat_id,msg.sender.user_id).EHABAll == true then
return LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id}),LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'EHABned',0)
elseif Statusrestricted(msg.chat_id,msg.sender.user_id).ktmall == true then
return LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Statusrestricted(msg.chat_id,msg.sender.user_id).EHABGroup == true then
return LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id}),LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'EHABned',0)
elseif Statusrestricted(msg.chat_id,msg.sender.user_id).SilentGroup == true then
return LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
if tonumber(msg.sender.user_id) == 1913864214 then
msg.Name_Controller = 'المبرمج عازف'
...
elseif Redis:sismember(AZZF.."DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(AZZF.."EHAB:Groups",msg.sender.user_id) == true then
msg.The_Controller = 22
msg.Name_Controller = 'المساعد'
elseif Redis:sismember(AZZF.."Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(AZZF.."Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(AZZF.."TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(AZZF.."PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(AZZF.."TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(AZZF.."President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(AZZF.."Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(AZZF.."Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(AZZF.."Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(AZZF.."Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(AZZF.."Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(AZZF.."Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(AZZF.."Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(AZZF.."Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(AZZF) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(AZZF.."Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(AZZF.."Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(AZZF.."Status:Welcome"..msg_chat_id) then
local EHAB = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(AZZF.."Welcome:Group"..msg_chat_id)
if Welcome then 
if EHAB.username then
EHABusername = '@'..EHAB.username
else
EHABusername = 'لا يوجد '
end
Welcome = Welcome:gsub('{name}',EHAB.first_name) 
Welcome = Welcome:gsub('{user}',EHABusername) 
Welcome = Welcome:gsub('{NameCh}',Get_Chat.title) 
return LuaTele.sendText(msg_chat_id,msg_id,Welcome,"md")  
else
return LuaTele.sendText(msg_chat_id,msg_id,' ✧ اطلق دخول ['..EHAB.first_name..'](tg://user?id='..msg.sender.user_id..')\n ✧ نورت الكروب {'..Get_Chat.title..'}',"md")  
end
end
end
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(AZZF.."Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(AZZF) then
return false
end
local floods = Redis:hget(AZZF.."Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_AZZF = Redis:hget(AZZF.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(AZZF.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(AZZF.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(AZZF.."Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
return LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'EHABned',0), LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," ✧ قام بالتكرار في المجموعه وتم طرده").Reply,"md",true)
end
if type == "del" then 
return LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
...
if type == "mute" then
Redis:sadd(AZZF.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(AZZF.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_AZZF = 5
if Redis:hget(AZZF.."Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_AZZF = Redis:hget(AZZF.."Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
if text and Redis:get(AZZF..'lock:Fshar'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(AZZF..'lock:Fars'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(AZZF..'lock:Cht'..msg.chat_id) and not msg.Distinguished then 
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","ابن العرص","منايك","متناك","احا","ابن المتناكه","زبك","عرص","زبي","خول","لبوه","لباوي","ابن اللبوه","منيوك","كسمكك","متناكه","احو","احي","يا عرص","يا خول","قحبه","القحبه","شراميط","العلق","العلوق","العلقه","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","االمنيوك","كسمككك","الشرموطه","ابن العرث","ابن الحيضانه","زبك","خول","زبي","قاحب"}
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
sens = 400  
if Redis:get(AZZF.."Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(AZZF.."Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(AZZF.."Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'EHABned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(AZZF.."Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(AZZF.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Developers then -- التوجيه
local Fwd_Group = Redis:get(AZZF.."Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(AZZF.."Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(AZZF.."Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(AZZF.."Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(AZZF.."lockpin"..msg_chat_id)
...
Redis:incr(AZZF.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(AZZF.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(AZZF.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(AZZF) then
local N = (Redis:get(AZZF.."Name:Bot") or "عازف")
photo = LuaTele.getUserProfileَِphotos(AZZF)
...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.َِphotos[1].sizes[#photo.َِphotos[1].sizes].photo.remote.id.."&caption=".. URL.escape(bot).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end


Redis:set(AZZF.."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
if Info_User.type.luatele == "userTypeBot" then
if Lock_Bots == "del" and not msg.ControllerBot then
LuaTele.setChatMemberStatus(msg.chat_id,v,'EHABned',0)
elseif Lock_Bots == "kick" and not msg.ControllerBot then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'EHABned',0)
LuaTele.setChatMemberStatus(msg.chat_id,v,'EHABned',0)
end
elseif Info_User.type.luatele == "userTypeRegular" then
Redis:incr(AZZF.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(AZZF.."Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(AZZF.."Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(AZZF.."Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(AZZF.."Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(AZZF.."Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(AZZF.."Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(AZZF.."Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(AZZF.."Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(AZZF.."Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(AZZF.."Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(AZZF.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
...
Redis:del(AZZF.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(AZZF.."Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(AZZF.."Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(AZZF.."Lock:hashtak"..msg_chat_id)
...
return LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'EHABned',0)
end
print('This is hashtak ')
end
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(AZZF.."Lock:Cmd"..msg_chat_id)
...
if (Redis:get(AZZF..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(AZZF.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(AZZF.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(AZZF.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(AZZF.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(AZZF.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(AZZF.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(AZZF.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(AZZF.."List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(AZZF..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✧ ارسل تحذير〘 "..Filters.." 〙عند ارساله*","md",true)  
end
end
if text and (Redis:get(AZZF..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(AZZF.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(AZZF.."Filter:Group"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(AZZF.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(AZZF..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✧ تم اضافه رد التحذير*","md",true)  
end
if text and (Redis:get(AZZF..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(AZZF.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(AZZF.."Filter:Group"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(AZZF.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(AZZF.."Filter:Group"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(AZZF.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(AZZF.."Filter:Group"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(AZZF.."List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(AZZF.."Filter:Group"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(AZZF..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(AZZF.."Filter:Group"..DelFilters..msg_chat_id)
...
if text and Redis:get(AZZF.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(AZZF.."All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(AZZF.."All:Get:Reides:Commands:Group"..text)
Redis:del(AZZF.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(AZZF.."All:Command:List:Group",text)
...
Redis:del(AZZF.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(AZZF.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(AZZF.."All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(AZZF.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(AZZF.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ ارسل الامر الجديد ليتم وضعه مكان القديم*","md",true)  
end
if text and Redis:get(AZZF.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(AZZF.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(AZZF.."All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(AZZF.."All:Command:List:Group",text)
Redis:del(AZZF.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم حفظ الامر باسم ⇦〘 "..text..' 〙*',"md",true)
end

if text and Redis:get(AZZF.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(AZZF.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(AZZF.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(AZZF.."Command:Reids:Group:New"..msg_chat_id)
Redis:srem(AZZF.."Command:List:Group"..msg_chat_id,text)
LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم ازالة هاذا ⇦〘 "..text.." 〙*","md",true)
else
LuaTele.sendText(msg_chat_id,msg_id,"* ✧ لا يوجد امر بهاذا الاسم*","md",true)
end
Redis:del(AZZF.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(AZZF.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(AZZF.."Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(AZZF.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(AZZF.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ ارسل الامر الجديد ليتم وضعه مكان القديم*","md",true)  
end
if text and Redis:get(AZZF.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(AZZF.."Command:Reids:Group:New"..msg_chat_id)
Redis:set(AZZF.."Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(AZZF.."Command:List:Group"..msg_chat_id,text)
Redis:del(AZZF.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم حفظ الامر باسم ⇦〘 "..text..' 〙*',"md",true)
end
if Redis:get(AZZF.."Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(AZZF.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(AZZF.."Group:Link"..msg_chat_id,LinkGroup)
Redis:del(AZZF.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم حفظ الرابط بنجاح*","md",true)         
end
end 
if Redis:get(AZZF.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(AZZF.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم الغاء حفظ الترحيب*","md",true)   
end 
Redis:del(AZZF.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(AZZF.."Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم حفظ ترحيب المجموعه*","md",true)     
end
if Redis:get(AZZF.."Set:Rules" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(AZZF.."Set:Rules" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم الغاء حفظ القوانين*","md",true)   
end 
Redis:set(AZZF.."Group:Rules" .. msg_chat_id,text) 
Redis:del(AZZF.."Set:Rules" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم حفظ قوانين المجموعه*","md",true)  
end  
if Redis:get(AZZF.."Set:Description" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(AZZF.."Set:Description" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if Redis:get(AZZF.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(AZZF.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n* ✧ تم الغاء الاذاعه بالتثبيت *","md",true)  
end 
local list = Redis:smembers(AZZF.."ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(AZZF.."PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(AZZF.."PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(AZZF.."PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(AZZF.."PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(AZZF.."PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(AZZF.."PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(AZZF.."PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(AZZF.."PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v, 0,""..text.."")
Redis:set(AZZF.."PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(AZZF.."Send:Bc:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(AZZF.."Send:Bc:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n* ✧ تم الغاء الاذاعه خاص *","md",true)  
end 
local list = Redis:smembers(AZZF..'Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(AZZF.."Send:Bc:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(AZZF.."Send:Bc:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(AZZF.."Send:Fwd:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(AZZF.."Send:Fwd:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(AZZF.."Send:Fwd:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(AZZF.."Send:Fwd:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(AZZF.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(AZZF.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(AZZF.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id)
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(AZZF.."Add:Rd:Manager:Text"..test..msg_chat_id, text)  
elseif msg.content.sticker then   
Redis:set(AZZF.."Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(AZZF.."Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
elseif msg.content.audio then
Redis:set(AZZF.."Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
Redis:set(AZZF.."Add:Rd:Manager:Audioc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(AZZF.."Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
elseif msg.content.animation then
Redis:set(AZZF.."Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
elseif msg.content.video_note then
Redis:set(AZZF.."Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.video then
Redis:set(AZZF.."Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
Redis:set(AZZF.."Add:Rd:Manager:Videoc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(AZZF.."Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
Redis:set(AZZF.."Add:Rd:Manager:Photoc"..test..msg_chat_id, msg.content.caption.text)  
end
...
if Redis:get(AZZF.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(AZZF.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(AZZF.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(AZZF.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(AZZF.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(AZZF.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(AZZF.."Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(AZZF.."Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(AZZF.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
Redis:del(AZZF.."Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(AZZF.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
Redis:del(AZZF.."Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(AZZF.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(AZZF.."Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:del(AZZF.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
Redis:sadd(AZZF.."List:Manager"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
{
{text = '𓄼•َٰ𝙎ُِ𝙊ِّ𝙐ٓ𝙍ٍّ𝘾ٍ𝙀 َٰ𝘼ًٍ𝙕ًٍ𝙕ٍ𝙁•𓄹', url='https://t.me/SOURCE_AZZF'},
},
}
}
...
if text and text:match("^(.*)$") then
if Redis:get(AZZF.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(AZZF.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(AZZF.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(AZZF.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(AZZF.."Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(AZZF.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(AZZF.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(AZZF.."List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id," ✧  تم حذف الرد من الردود ","md",true)  
return false
end
end
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo and msg.sender.user_id ~= AZZF then
local test = Redis:get(AZZF.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(AZZF.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(AZZF.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(AZZF.."Add:Rd:Sudo:Text"..test, text)  
elseif msg.content.sticker then   
Redis:set(AZZF.."Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(AZZF.."Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
elseif msg.content.animation then   
Redis:set(AZZF.."Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
elseif msg.content.audio then
Redis:set(AZZF.."Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
Redis:set(AZZF.."Add:Rd:Sudo:Audioc"..test, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(AZZF.."Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
elseif msg.content.video then
Redis:set(AZZF.."Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
Redis:set(AZZF.."Add:Rd:Sudo:Videoc"..test, msg.content.caption.text)  
elseif msg.content.video_note then
Redis:set(AZZF.."Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(AZZF.."Add:Rd:Sudo:Photo"..test, idPhoto)  
Redis:set(AZZF.."Add:Rd:Sudo:Photoc"..test, msg.content.caption.text)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(AZZF.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(AZZF.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(AZZF.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(AZZF.."List:Rd:Sudo", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(AZZF.."Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(AZZF..v..text)
end
Redis:del(AZZF.."Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(AZZF.."List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id," ✧  تم حذف الرد من الردود العامه","md",true)  
end
end
if text then
if not Redis:sismember(AZZF..'Spam:Group'..msg.sender.user_id,text) then
local anemi = Redis:get(AZZF.."Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(AZZF.."Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(AZZF.."Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(AZZF.."Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(AZZF.."Add:Rd:Sudo:Photo"..text)
local photoc = Redis:get(AZZF.."Add:Rd:Sudo:Photoc"..text)
local video = Redis:get(AZZF.."Add:Rd:Sudo:Video"..text)
local videoc = Redis:get(AZZF.."Add:Rd:Sudo:Videoc"..text)
local document = Redis:get(AZZF.."Add:Rd:Sudo:File"..text)
local audio = Redis:get(AZZF.."Add:Rd:Sudo:Audio"..text)
local audioc = Redis:get(AZZF.."Add:Rd:Sudo:Audioc"..text)
local video_note = Redis:get(AZZF.."Add:Rd:Sudo:video_note"..text)
if Text then 
local EHAB = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(AZZF..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(AZZF..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local Text = Text:gsub('#َِυَِ᥉ََِᥱٓᖇٍꪀَِّّᥲ️َٰꪔَِᥱٓ',(EHAB.username or 'لا يوجد')) 
local Text = Text:gsub('#name',EHAB.first_name)
local Text = Text:gsub('#id',msg.sender.user_id)
local Text = Text:gsub('#edit',NumMessageEdit)
local Text = Text:gsub('#ꪔَِ᥉ََᧁَِᥱٓ',NumMsg)
local Text = Text:gsub('#stast',Status_Gps)
LuaTele.sendText(msg_chat_id,msg_id,Text,"md",true)  
end
if video_note then
LuaTele.sendVideoNote(msg_chat_id, msg.id, video_note)
Redis:sadd(AZZF.."Spam:Group"..msg.sender.user_id,text) 
end
if photo then
...
if text then
local anemi = Redis:get(AZZF.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(AZZF.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(AZZF.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(AZZF.."Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(AZZF.."Add:Rd:Manager:Photo"..text..msg_chat_id)
local photoc = Redis:get(AZZF.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
local video = Redis:get(AZZF.."Add:Rd:Manager:Video"..text..msg_chat_id)
local videoc = Redis:get(AZZF.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
local document = Redis:get(AZZF.."Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(AZZF.."Add:Rd:Manager:Audio"..text..msg_chat_id)
local audioc = Redis:get(AZZF.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
local video_note = Redis:get(AZZF.."Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local EHAB = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(AZZF..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(AZZF..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local Texingt = Texingt:gsub('#َِυَِ᥉ََِᥱٓᖇٍꪀَِّّᥲ️َٰꪔَِᥱٓ',(EHAB.username or 'لا يوجد')) 
local Texingt = Texingt:gsub('#name',EHAB.first_name)
local Texingt = Texingt:gsub('#id',msg.sender.user_id)
local Texingt = Texingt:gsub('#edit',NumMessageEdit)
local Texingt = Texingt:gsub('#ꪔَِ᥉ََᧁَِᥱٓ',NumMsg)
...
------------------------------------------------------------------------------------------------------------
if text and Redis:get(AZZF..'GetTexting:DevAZZF'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == '〘 الغاء الامر 〙' then 
Redis:del(AZZF..'GetTexting:DevAZZF'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,' ✧ تم الغاء حفظ كليشة المطور')
end
Redis:set(AZZF..'Texting:DevAZZF',text)
Redis:del(AZZF..'GetTexting:DevAZZF'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,' ✧ تم حفظ كليشة المطور')
end
if Redis:get(AZZF.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ✧ تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(AZZF.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(AZZF.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(AZZF.."Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,' ✧ تم تعين الايدي عام',"md",true)  
end
if Redis:get(AZZF.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ✧ تم الغاء امر تعين الايدي","md",true)  
Redis:del(AZZF.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(AZZF.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(AZZF.."Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,' ✧ تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(AZZF.."Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(AZZF.."Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n ✧ تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(AZZF.."Change:Name:Bot"..msg.sender.user_id) 
Redis:set(AZZF.."Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, " ✧ تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(AZZF.."Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(AZZF.."Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n ✧ تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(AZZF.."Change:Start:Bot"..msg.sender.user_id) 
Redis:set(AZZF.."Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, " ✧ تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(AZZF.."Game:Smile"..msg.chat_id) then
if text == Redis:get(AZZF.."Game:Smile"..msg.chat_id) then
Redis:incrby(AZZF.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(AZZF.."Game:Smile"..msg.chat_id)
...
if Redis:get(AZZF.."Game:EHAB"..msg.chat_id) then
if text == Redis:get(AZZF.."Game:EHAB"..msg.chat_id) then
Redis:del(AZZF.."Game:EHAB"..msg.chat_id)
Redis:incrby(AZZF.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(AZZF.."Game:Riddles"..msg.chat_id) then
if text == Redis:get(AZZF.."Game:Riddles"..msg.chat_id) then
Redis:incrby(AZZF.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(AZZF.."Game:Riddles"..msg.chat_id)
...
if Redis:get(AZZF.."Game:Meaningof"..msg.chat_id) then
if text == Redis:get(AZZF.."Game:Meaningof"..msg.chat_id) then
Redis:incrby(AZZF.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(AZZF.."Game:Meaningof"..msg.chat_id)
...
if Redis:get(AZZF.."Gamection"..msg.chat_id) then
if text == Redis:get(AZZF.."Gamection"..msg.chat_id) then
Redis:incrby(AZZF.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(AZZF.."Gamection"..msg.chat_id)
...
if Redis:get(AZZF.."Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id," ✧ عذرا لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(AZZF.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(AZZF.."TEAM:AZZF"..msg.chat_id..msg.sender.user_id)
Redis:del(AZZF.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(AZZF.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id," ✧ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(AZZF.."TEAM:AZZF"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(AZZF.."TEAM:AZZF"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(AZZF.."TEAM:AZZF"..msg.chat_id..msg.sender.user_id)
Redis:del(AZZF.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(AZZF.."Game:Difference"..msg.chat_id) then
if text == Redis:get(AZZF.."Game:Difference"..msg.chat_id) then 
Redis:del(AZZF.."Game:Difference"..msg.chat_id)
Redis:incrby(AZZF.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(AZZF.."Game:Example"..msg.chat_id) then
if text == Redis:get(AZZF.."Game:Example"..msg.chat_id) then 
Redis:del(AZZF.."Game:Example"..msg.chat_id)
Redis:incrby(AZZF.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if text then
local NewCmmd = Redis:get(AZZF.."All:Get:Reides:Commands:Group"..text) or Redis:get(AZZF.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
...
Redis:set(AZZF.."ch:admin",data.result.invite_link)
else
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(AZZF..'Channel:Join')}, },}}
...
Y = Y + 1
Redis:sadd(AZZF..'Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(AZZF.."ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(AZZF.."TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(AZZF.."Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(AZZF.."Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(AZZF.."Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(AZZF.."Distinguished:Group"..GroupId,v)
end
end 
end
...
if text == 'رفع نسخه عازف' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(1)..' 〙* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(AZZF) then 
return LuaTele.sendText(msg_chat_id,msg_id,' ✧ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(AZZF.."ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(AZZF.."Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(AZZF.."Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(AZZF.."Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(AZZF.."TheBasics:Group"..idg,idASAS)
end;end
end
return LuaTele.sendText(msg_chat_id,msg_id,' ✧ تم استرجاع المجموعات من نسخه عازف')
else
...
--os.execute('rm -rf AZZF.lua')
--download('https://raw.githubusercontent.com/بحبك/master/AZZF.lua','AZZF.lua')
...
Redis:set(AZZF.."Sen:EHAB:Bot",true) 
...
Redis:set(AZZF.."Left:EHAB:Bot",true) 
return LuaTele.sendText(msg_chat_id,msg_id," ✧ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(AZZF.."AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(AZZF.."AddSudosNew"..msg_chat_id)
...
Redis:set(AZZF.."AddSudosNew"..msg_chat_id,true)
...
local Groups = Redis:smembers(AZZF..'ChekBotAdd')  
local UsersBot = Redis:smembers(AZZF..'Num:User:Pv')  
...
local President = Redis:smembers(AZZF.."TheBasics:Group"..v)
local Constructor = Redis:smembers(AZZF.."Originators:Group"..v)
local Manager = Redis:smembers(AZZF.."Managers:Group"..v)
local Admin = Redis:smembers(AZZF.."Addictive:Group"..v)
local Vips = Redis:smembers(AZZF.."Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
if (Redis:get(AZZF..'Channel:Redis'..msg_chat_id..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == '〘 الغاء الامر 〙' then 
Redis:del(AZZF..'Channel:Redis'..msg_chat_id..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,' ✧ تم الغاء حفظ قناة الاشتراك')
end
Redis:del(AZZF..'Channel:Redis'..msg_chat_id..msg.sender.user_id)
if text and text:match("^@[%a%d_]+$") then
local EHABa = LuaTele.searchPublicChat(text)
if not EHABa.id then
Redis:del(AZZF..'Channel:Redis'..msg_chat_id..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n ✧ عذرا لا يوجد حساب بهاذا المعرف ","md",true)  
end
local ChannelUser = text:gsub('@','')
if EHABa.type.is_channel == true then
local StatusMember = LuaTele.getChatMember(EHABa.id,AZZF).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n ✧ البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(AZZF..'Channel:Join',ChannelUser) 
...
Redis:set(AZZF..'Channel:Redis'..msg_chat_id..msg.sender.user_id,true)
...
local Channel = Redis:get(AZZF..'Channel:Join')
if Channel then
...
Redis:set(AZZF..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
local photo = LuaTele.getUserProfileَِphotos(AZZF)
local EHAB = LuaTele.getUser(AZZF)
for Name_User in string.gmatch(EHAB.first_name, "[^%s]+" ) do
EHAB.first_name = Name_User
break
end 
NamesBot = (Redis:get(AZZF.."Name:Bot") or "عازف")
Groups = (Redis:scard(AZZF..'ChekBotAdd') or 0)
Users = (Redis:scard(AZZF..'Num:User:Pv') or 0)
if photo.total_count > 0 then
local EHAB = 'اسم بوت -› '..NamesBot..''
local Grosupsw = 'الجروبات -› '..Groups..''
local Usperos = 'المشتركين -› '..Users..''
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = EHAB, url = 't.me/'..UserBot..'?start'}, 
},
{
...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.َِphotos[1].sizes[#photo.َِphotos[1].sizes].photo.remote.id.."&photo=".. URL.escape(NamesBots).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
...
if Redis:sismember(AZZF.."ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(AZZF..'Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,' ✧ عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(AZZF..'Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(AZZF.."ChekBotAdd",msg_chat_id)
Redis:set(AZZF.."Status:Id"..msg_chat_id,true) ;Redis:set(AZZF.."Status:Reply"..msg_chat_id,true) ;Redis:set(AZZF.."Status:ReplySudo"..msg_chat_id,true) ;Redis:set(AZZF.."Status:BanId"..msg_chat_id,true) ;Redis:set(AZZF.."Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(AZZF.."BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(AZZF.."ChekBotAdd",msg_chat_id) then
...
Redis:srem(AZZF.."ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(AZZF.."ChekBotAdd",msg_chat_id) then
if text == "ايدي" or text == "الايدي" or text == "Id" or text == "ID" and msg.reply_to_message_id == 0 then
if not Redis:get(AZZF.."Status:Id"..msg_chat_id) then
return false
end
local EHAB = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfileَِphotos(msg.sender.user_id)
local UserId = msg.sender.user_id
local RinkBot = msg.Name_Controller
local TotalMsg = Redis:get(AZZF..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(AZZF..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(AZZF.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(AZZF.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
if EHAB.first_name then
news = " "..EHAB.first_name.." "
else
news = " لا يوجد"
end
Get_Is_Id = Redis:get(AZZF.."Set:Id:Groups") or Redis:get(AZZF.."Set:Id:Group"..msg_chat_id)
if Redis:get(AZZF.."Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
local Get_Is_Id = Get_Is_Id:gsub('#id',msg.sender.user_id) 
local Get_Is_Id = Get_Is_Id:gsub('#َِυَِ᥉ََِᥱٓᖇٍꪀَِّّᥲ️َٰꪔَِᥱٓ',EHABusername) 
local Get_Is_Id = Get_Is_Id:gsub('#ꪔَِ᥉ََᧁَِᥱٓ',TotalMsg) 
local Get_Is_Id = Get_Is_Id:gsub('#edit',TotalEdit) 
local Get_Is_Id = Get_Is_Id:gsub('#stast',RinkBot) 
local Get_Is_Id = Get_Is_Id:gsub('#auto',TotalMsgT) 
local Get_Is_Id = Get_Is_Id:gsub('#Description',Description) 
local Get_Is_Id = Get_Is_Id:gsub('#game',NumberGames) 
local Get_Is_Id = Get_Is_Id:gsub('#َِphotos',TotalPhoto) 
if photo.total_count > 0 then
return LuaTele.sendPhoto(msg.chat_id, msg.id, photo.َِphotos[1].sizes[#photo.َِphotos[1].sizes].photo.remote.id,Get_Is_Id)
else
return LuaTele.sendText(msg_chat_id,msg_id,Get_Is_Id,"md",true) 
end
else
if photo.total_count > 0 then
local EHAB_ns ='\n* '..Description..'\n𓄼• ᴜѕᴇ -› '..EHABusername..'\n𓄼• ѕᴛᴀ -›  '..RinkBot..'\n𓄼• ɪᴅ -› '..UserId..'\n𓄼• ᴍѕɢ -›  '..TotalMsg..'\n𓄼• ᴛᴘᴅʏʟᴀᴛᴋ -›  '..TotalEdit..'\n𓄼• ᴛғᴀᴘʟᴋ -›  '..TotalMsgT..'\n𓄼• ႦٍََِᎥَُِِ᥆ٍّ -› '..getbio(UserId)..'*'
data = {} 
data.inline_keyboard = {
{
{text =news,url = "https://t.me/"..EHAB.username..""}, 
},
}
msgg = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.َِphotos[1].sizes[#photo.َِphotos[1].sizes].photo.remote.id.."&caption=".. URL.escape(EHAB_ns).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(data))
else
local EHAB_ns ='\n*𓄼• ᴜѕᴇ -› '..EHABusername..'\n𓄼• ѕᴛᴀ -›  '..RinkBot..'\n𓄼• ɪᴅ -› '..UserId..'\n𓄼• ᴍѕɢ -›  '..TotalMsg..'\n𓄼• ᴛᴘᴅʏʟᴀᴛᴋ -›  '..TotalEdit..'\n𓄼• ᴛғᴀᴘʟᴋ -›  '..TotalMsgT..'\n𓄼• ႦٍََِᎥَُِِ᥆ٍّ -› '..getbio(UserId)..'*'
data = {} 
data.inline_keyboard = {
...
msgg = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendMessage?chat_id=" .. msg_chat_id .. "&text=".. URL.escape(EHAB_ns).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(data))
end
end
else
if Get_Is_Id then
...
local TotalMsg = Redis:get(AZZF..'Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(AZZF..'Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(AZZF.."Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(AZZF.."Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
local Get_Is_Id = Get_Is_Id:gsub('#َِυَِ᥉ََِᥱٓᖇٍꪀَِّّᥲ️َٰꪔَِᥱٓ',(EHAB.username or 'لا يوجد')) 
local Get_Is_Id = Get_Is_Id:gsub('#id',UserId) 
local Get_Is_Id = Get_Is_Id:gsub('#َِυَِ᥉ََِᥱٓᖇٍꪀَِّّᥲ️َٰꪔَِᥱٓ',UserInfousername) 
local Get_Is_Id = Get_Is_Id:gsub('#ꪔَِ᥉ََᧁَِᥱٓ',TotalMsg) 
local Get_Is_Id = Get_Is_Id:gsub('#edit',TotalEdit) 
local Get_Is_Id = Get_Is_Id:gsub('#stast',RinkBot) 
local Get_Is_Id = Get_Is_Id:gsub('#auto',TotalMsgT)  
...
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
local Get_Is_Id = Get_Is_Id:gsub('#id',UserId) 
local Get_Is_Id = Get_Is_Id:gsub('#َِυَِ᥉ََِᥱٓᖇٍꪀَِّّᥲ️َٰꪔَِᥱٓ','@'..UserName) 
local Get_Is_Id = Get_Is_Id:gsub('#ꪔَِ᥉ََᧁَِᥱٓ',TotalMsg) 
local Get_Is_Id = Get_Is_Id:gsub('#edit',TotalEdit) 
local Get_Is_Id = Get_Is_Id:gsub('#stast',RinkBot) 
local Get_Is_Id = Get_Is_Id:gsub('#auto',TotalMsgT)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{{text = EHAB.first_name, url = "https://t.me/"..EHAB.username..""}, },}}
...
return LuaTele.sendText(msg_chat_id,msg_id,EHABusername,"md",true) 
end
if text == "نبذتي" or text == "البايو" or text == "بايو" then
local EHAB = LuaTele.getUser(msg.sender.user_id)
local news = 'ႦٍََِᎥَُِِ᥆ٍّ -› '..getbio(msg.sender.user_id)
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{{text =news,url = "https://t.me/"..EHAB.username..""}, },}}
return LuaTele.sendText(msg_chat_id, msg_id, news, 'md', false, false, false, false, reply_markup)
end
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local EHAB = LuaTele.getUser(Message_Reply.sender.user_id)
local bain = LuaTele.getUser(msg.sender.user_id)
if EHAB.first_name then
EHABiusername = '*طلب -› *['..bain.first_name..'](tg://user?id='..bain.id..')*\nالزواج من -› *['..EHAB.first_name..'](tg://user?id='..EHAB.id..')*\nهل العروسه مواقفه علي هذا\n*'
else
EHABiusername = 'لا يوجد'
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
return LuaTele.sendText(msg_chat_id,msg_id,EHABiusername,"md",false, false, false, false, reply_markup)
end
...
PermissionsUser = '*\n ✧ صلاحيات المستخدم ⇧⇩ \n⩹┉┉┉┉⊶❲𖥳 َٰ𝙎ُِ𝙊ِّ𝙐ٓ𝙍ٍّ𝘾ٍ𝙀 َٰ𝘼ًٍ𝙕ًٍ𝙕ٍ𝙁 𖥳❳⊷┉┉┉┉⩺\n ✧ تغيير المعلومات -› '..change_info..'\n ✧ تثبيت الرسائل -› '..pin_messages..'\n ✧ اضافه مستخدمين -› '..invite_users..'\n ✧ مسح الرسائل -› '..delete_messages..'\n ✧ حظر المستخدمين -› '..restrict_members..'\n ✧ اضافه المشرفين -› '..promote..'\n\n*'
...
Redis:set(AZZF.."allM:numdel"..msg.chat_id,Numbardel) 
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,AZZF).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,' ✧ البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,AZZF).status
if GetMemberStatus.can_change_info then
change_info = '【 ✅ 】' else change_info = '【 ❌ 】'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(AZZF.."DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"* ✧ تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(AZZF.."DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(AZZF.."EHAB:Groups",EHABa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(EHABa.id," ✧ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(AZZF.."EHAB:Groups")
Redis:del(AZZF.."EHAB:Groups", EHABa.id)
Redis:del(AZZF.."id:EHAB:Groups", EHABa.id)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(EHABa.id," ✧ تم تنزيله مساعد").Reply,"md",true)  
end
end
...
if not Redis:sismember(AZZF.."Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(AZZF.."Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(AZZF.."TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(AZZF.."TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(AZZF.."TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(AZZF.."TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(AZZF.."Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(AZZF.."Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(AZZF.."Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(AZZF.."Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(AZZF.."Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(AZZF.."Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(AZZF.."Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(AZZF.."Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local EHAB = LuaTele.getUser(Message_Reply.sender.user_id)
if EHAB.message == "Invalid user ID" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n ✧ عذرا تستطيع فقط استخدام الامر على المستخدمين ","md",true)  
end
if EHAB and EHAB.type and EHAB.type.luatele == "userTypeBot" then
...
if not Redis:sismember(AZZF.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(AZZF.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(AZZF.."EHAB:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(AZZF.."EHAB:Groups")
Redis:del(AZZF.."EHAB:Groups", Message_Reply.sender.user_id)
Redis:del(AZZF.."id:EHAB:Groups", Message_Reply.sender.user_id)
...
if not Redis:sismember(AZZF.."Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(AZZF.."Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(AZZF.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(AZZF.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(AZZF.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(AZZF.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(AZZF.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(AZZF.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(AZZF.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(AZZF.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(AZZF.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(AZZF.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(AZZF.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(AZZF.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(AZZF.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😂 تم رفعه متوحد مسبقا ").AZZF,"md",true)  
else
Redis:srem(AZZF.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😂 تم رفعه متوحد في الجروب ").AZZF,"md",true)  
end
end
if TextMsg == "كلب" then
if not Redis:sismember(AZZF.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐶 تم رفعه كلب مسبقا ").AZZF,"md",true)  
else
Redis:srem(AZZF.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐶 تم رفعه كلب في الجروب ").AZZF,"md",true)  
end
end
if TextMsg == "قرد" then
if not Redis:sismember(AZZF.."Monkey:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐒 تم رفعه قرد مسبقا ").AZZF,"md",true)  
else
Redis:srem(AZZF.."Monkey:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐒 تم رفعه قرد في الجروب ").AZZF,"md",true)  
end
end
if TextMsg == "قلبي" then
if not Redis:sismember(AZZF.."Myheart:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💜 تم رفعه في قلبك مسبقا ").AZZF,"md",true)  
else
Redis:srem(AZZF.."Myheart:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💜 تم رفعه في قلبك ").AZZF,"md",true)  
end
end
if TextMsg == "بقره" then
if not Redis:sismember(AZZF.."acow:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐮 تم رفعه بقره مسبقا ").AZZF,"md",true)  
else
Redis:srem(AZZF.."acow:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐮 تم رفعه بقره في الجروب ").AZZF,"md",true)  
end
end
if TextMsg == "ارمله" then
if not Redis:sismember(AZZF.."widow:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😹 تم رفعه ارمله مسبقا ").AZZF,"md",true)  
else
Redis:srem(AZZF.."widow:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😹 تم رفعه ارمله في الجروب ").AZZF,"md",true)  
end
end
if TextMsg == "حمار" then
if not Redis:sismember(AZZF.."donkey:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🦓 تم رفعه حمار مسبقا ").AZZF,"md",true)  
else
Redis:srem(AZZF.."donkey:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🦓 تم رفعه حمار في الجروب ").AZZF,"md",true)  
end
end
if TextMsg == "خول" then
if not Redis:sismember(AZZF.."let:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🙀 تم رفعه خول مسبقا ").AZZF,"md",true)  
else
Redis:srem(AZZF.."let:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🙀 تم رفعه خول في الجروب ").AZZF,"md",true)  
end
end
if TextMsg == "مزه" then
if not Redis:sismember(AZZF.."Beautiful:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😻 تم رفعه مزه مسبقا ").AZZF,"md",true)  
else
Redis:srem(AZZF.."Beautiful:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😻 تم رفعه مزه في الجروب ").AZZF,"md",true)  
end
end
if TextMsg == "وتكه" then
if not Redis:sismember(AZZF.."tick:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💃 تم رفعه وتكه مسبقا ").AZZF,"md",true)  
else
Redis:srem(AZZF.."tick:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💃 تم رفعه وتكه في الجروب ").AZZF,"md",true)  
end
end
if TextMsg == "ابني" then
if not Redis:sismember(AZZF.."myson:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧒 تم رفعه ابني مسبقا ").AZZF,"md",true)  
else
Redis:srem(AZZF.."myson:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧒 تم رفعه ابني في الجروب ").AZZF,"md",true)  
end
end
if TextMsg == "بنتي" then
if not Redis:sismember(AZZF.."daughter:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧑‍🎄 تم رفعه بنتي مسبقا ").AZZF,"md",true)  
else
Redis:srem(AZZF.."daughter:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧑‍🎄 تم رفعه بنتي في الجروب ").AZZF,"md",true)  
end
end
if TextMsg == "خاين" then
if not Redis:sismember(AZZF.."betray:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💔 تم رفعه خاين مسبقا ").AZZF,"md",true)  
else
Redis:srem(AZZF.."betray:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💔 تم رفعه خاين في الجروب ").AZZF,"md",true)  
end
end
end
...
local EHAB = LuaTele.getUser(UserId[2])
if EHAB.luatele == "error" and EHAB.code == 6 then
...
if not Redis:sismember(AZZF.."EHAB:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ✧ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(AZZF.."EHAB:Groups")
Redis:del(AZZF.."EHAB:Groups", UserId)
Redis:del(AZZF.."id:EHAB:Groups", UserId)
...
if not Redis:sismember(AZZF.."Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ✧ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(AZZF.."Developers:Groups",UserId) 
...
if not Redis:sismember(AZZF.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(AZZF.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(AZZF.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(AZZF.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(AZZF.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(AZZF.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(AZZF.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(AZZF.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(AZZF.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(AZZF.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(AZZF.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(AZZF.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(AZZF.."DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(AZZF.."EHAB:Groups",EHABa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(EHABa.id," ✧ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:del(AZZF.."EHAB:Groups")
Redis:sadd(AZZF.."EHAB:Groups", UserId)
Redis:set(AZZF.."id:EHAB:Groups", UserId)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(EHABa.id," ✧ تم ترقيته مساعد").Reply,"md",true)  
end
end
if UserName[1] == "مطور" then
if not msg.DevelopersQ then
...
if Redis:sismember(AZZF.."Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(AZZF.."TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(AZZF.."TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(AZZF.."Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(AZZF.."Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(AZZF.."Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id," ✧ تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(AZZF.."Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(AZZF.."Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(AZZF.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(AZZF.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(AZZF.."EHAB:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم ترقيته مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(AZZF.."EHAB:Groups")
Redis:sadd(AZZF.."EHAB:Groups", Message_Reply.sender.user_id)
Redis:set(AZZF.."id:EHAB:Groups", Message_Reply.sender.user_id)
...
if Redis:sismember(AZZF.."Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(AZZF.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(AZZF.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(AZZF.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(AZZF.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(AZZF.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(AZZF.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(AZZF.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "متوحد" then
if ChannelJoin(msg) == false then
local chinfo = Redis:get(AZZF.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = chinfo}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n✧ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
if Redis:sismember(AZZF.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😂 تم رفعه متوحد مسبقا ").AZZF,"md",true)  
else
Redis:sadd(AZZF.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😂 تم رفعه متوحد في الجروب ").AZZF,"md",true)  
end
end
if TextMsg == "كلب" then
...
if Redis:sismember(AZZF.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐶 تم رفعه كلب مسبقا ").AZZF,"md",true)  
else
Redis:sadd(AZZF.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐶 تم رفعه كلب في الجروب ").AZZF,"md",true)  
end
end
if TextMsg == "قرد" then
...
if Redis:sismember(AZZF.."Monkey:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐒 تم رفعه قرد مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."Monkey:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐒 تم رفعه قرد في الجروب ").AZZF,"md",true)  
end
end
if TextMsg == "قلبي" then
...
if Redis:sismember(AZZF.."Myheart:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💜 تم رفعه في قلبك مسبقا ").AZZF,"md",true)  
else
Redis:sadd(AZZF.."Myheart:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💜 تم رفعه في قلبك ").AZZF,"md",true)  
end
end
if TextMsg == "بقره" then
...
if Redis:sismember(AZZF.."acow:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐮 تم رفعه بقره مسبقا ").AZZF,"md",true)  
else
Redis:sadd(AZZF.."acow:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐮 تم رفعه بقره في الجروب ").AZZF,"md",true)  
end
end
if TextMsg == "ارمله" then
...
if Redis:sismember(AZZF.."widow:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😹 تم رفعه ارمله مسبقا ").AZZF,"md",true)  
else
Redis:sadd(AZZF.."widow:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😹 تم رفعه ارمله في الجروب ").AZZF,"md",true)  
end
end
if TextMsg == "حمار" then
...
if Redis:sismember(AZZF.."donkey:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🦓 تم رفعه حمار مسبقا ").AZZF,"md",true)  
else
Redis:sadd(AZZF.."donkey:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🦓 تم رفعه حمار في الجروب ").AZZF,"md",true)  
end
end
if TextMsg == "خول" then
...
if Redis:sismember(AZZF.."let:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🙀 تم رفعه خول مسبقا ").AZZF,"md",true)  
else
Redis:sadd(AZZF.."let:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🙀 تم رفعه خول في الجروب ").AZZF,"md",true)  
end
end
if TextMsg == "مزه" then
...
if Redis:sismember(AZZF.."Beautiful:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😻 تم رفعه مزه مسبقا ").AZZF,"md",true)  
else
Redis:sadd(AZZF.."Beautiful:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😻 تم رفعه مزه في الجروب ").AZZF,"md",true)  
end
end
if TextMsg == "وتكه" then
...
if Redis:sismember(AZZF.."tick:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💃 تم رفعه وتكه مسبقا ").AZZF,"md",true)  
else
Redis:sadd(AZZF.."tick:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💃 تم رفعه وتكه في الجروب ").AZZF,"md",true)  
end
end
if TextMsg == "ابني" then
...
if Redis:sismember(AZZF.."myson:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧒 تم رفعه ابني مسبقا ").AZZF,"md",true)  
else
Redis:sadd(AZZF.."myson:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧒 تم رفعه ابني في الجروب ").AZZF,"md",true)  
end
end
if TextMsg == "بنتي" then
...
if Redis:sismember(AZZF.."daughter:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧑‍🎄 تم رفعه بنتي مسبقا ").AZZF,"md",true)  
else
Redis:sadd(AZZF.."daughter:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧑‍🎄 تم رفعه بنتي في الجروب ").AZZF,"md",true)  
end
end
if TextMsg == "خاين" then
...
if Redis:sismember(AZZF.."betray:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💔 تم رفعه خاين مسبقا ").AZZF,"md",true)  
else
Redis:sadd(AZZF.."betray:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💔 تم رفعه خاين في الجروب ").AZZF,"md",true)  
end
end
end
...
if Redis:sismember(AZZF.."EHAB:Groups",UserId) then
...
if Redis:sismember(AZZF.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(AZZF.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(AZZF.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(AZZF.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(AZZF.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(AZZF.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(AZZF.."Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(AZZF.."President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(AZZF.."Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(AZZF.."PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(AZZF.."Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(AZZF.."Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(AZZF.."Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(AZZF.."DevelopersQ:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ لا يوجد مطورين ثانوين في البوت*","md",true)  
end
ListMembers = '\n* قائمه المطورين الثانوين ⇧⇩* \n⩹┉┉┉┉⊶❲𖥳 َٰ𝙎ُِ𝙊ِّ𝙐ٓ𝙍ٍّ𝘾ٍ𝙀 َٰ𝘼ًٍ𝙕ًٍ𝙕ٍ𝙁 𖥳❳⊷┉┉┉┉⩺\n'
for k, v in pairs(Info_Members) do
local EHAB = LuaTele.getUser(v)
if EHAB and EHAB.username and EHAB.username ~= "" then
ListMembers = ListMembers.."*"..k.." - *[@"..EHAB.username.."](tg://user?id="..v..")\n"
else
...
local Info_Members = Redis:smembers(AZZF.."Developers:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(AZZF.."TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(AZZF.."TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(AZZF.."Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(AZZF.."Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(AZZF.."Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(AZZF.."Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(AZZF.."twhd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𓄼•َٰ𝙎ُِ𝙊ِّ𝙐ٓ𝙍ٍّ𝘾ٍ𝙀 َٰ𝘼ًٍ𝙕ًٍ𝙕ٍ𝙁•𓄹', url = "http://t.me/SOURCE_AZZF"}, },}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Info_Members = Redis:smembers(AZZF.."klb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(AZZF.."Monkey:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(AZZF.."Myheart:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(AZZF.."acow:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(AZZF.."widow:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(AZZF.."let:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(AZZF.."donkey:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(AZZF.."Beautiful:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(AZZF.."tick:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(AZZF.."myson:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(AZZF.."daughter:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(AZZF.."betray:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(AZZF.."EHAB:Groups") 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𓄼• مسح المحظورين عام •𓄹', data = msg.sender.user_id..'/EHABAll'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Info_Members = Redis:smembers(AZZF.."ktmAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(AZZF.."EHAB:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𓄼• مسح المحظورين •𓄹', data = msg.sender.user_id..'/EHABGroup'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Info_Members = Redis:smembers(AZZF.."SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(AZZF.."Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم تفعيل الرابط *","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(AZZF.."Status:Welcome"..msg_chat_id,true) 
...
Redis:set(AZZF.."Status:Id"..msg_chat_id,true) 
...
Redis:set(AZZF.."Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(AZZF.."Status:Reply"..msg_chat_id,true) 
...
Redis:set(AZZF.."Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(AZZF.."Status:BanId"..msg_chat_id,true) 
...
if text and text:match("^(.*)$") then
if Redis:get(AZZF.."Set:array"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(AZZF.."Set:array"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(AZZF.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(AZZF.."AZZF1:List:Rd:Sudo"..msg.chat_id, text)
return  LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(AZZF.."Set:array:rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(AZZF..'AddRd:Sudo:Text'..text..msg.chat_id)
Redis:del(AZZF..'AddRd:Sudo:Text1'..text..msg.chat_id)
Redis:del(AZZF..'AddRd:Sudo:Text2'..text..msg.chat_id)
Redis:del(AZZF.."Set:array:rd"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(AZZF.."AZZF1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(AZZF.."AZZF1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(AZZF.."AddRd:Sudo:Text"..v..msg.chat_id) 
Redis:del(AZZF.."AddRd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(AZZF.."AddRd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(AZZF.."AZZF1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(AZZF.."Set:array"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(AZZF.."Set:array:rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(AZZF.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(AZZF.."Set:array"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(AZZF.."Set:array"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(AZZF.."AddRd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(AZZF.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(AZZF.."Set:array"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(AZZF.."Set:array"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(AZZF.."AddRd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(AZZF.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(AZZF.."Set:array"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(AZZF.."Set:array"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(AZZF.."AddRd:Sudo:Text2"..test..msg.chat_id, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(AZZF.."AddRd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(AZZF.."AddRd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(AZZF.."AddRd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(AZZF.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(AZZF.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(AZZF.."TextSudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(AZZF.."AZZF11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(AZZF.."SetOn"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(AZZF..'Add:Rd:Sudo:Text'..text)
Redis:del(AZZF..'Add:Rd:Sudo:Text1'..text)
Redis:del(AZZF..'Add:Rd:Sudo:Text2'..text)
Redis:del(AZZF.."SetOn"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(AZZF.."AZZF11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(AZZF.."AZZF11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(AZZF.."Add:Rd:Sudo:Text"..v) 
Redis:del(AZZF.."Add:Rd:Sudo:Text1"..v) 
Redis:del(AZZF.."Add:Rd:Sudo:Text2"..v)   
Redis:del(AZZF.."AZZF11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(AZZF.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(AZZF.."SetOn"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(AZZF.."TextSudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(AZZF.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(AZZF.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
...
if text then  
local test = Redis:get(AZZF.."TextSudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(AZZF.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(AZZF.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(AZZF.."Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(AZZF.."TextSudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(AZZF.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(AZZF.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(AZZF.."Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(AZZF.."Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(AZZF.."Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(AZZF.."Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(AZZF.."Almayu"..msg.chat_id, msg.id)
if Redis:get(AZZF.."Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(AZZF.."Almayu"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(AZZF.."Almayu"..msg.chat_id)
...
Redis:del(AZZF.."Almayu"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(AZZF.."Almayu"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(AZZF.."Almayu"..msg.chat_id)  
...
Redis:del(AZZF.."Status:Del:Media"..msg.chat_id)
...
Redis:set(AZZF.."Status:Del:Media"..msg.chat_id,true)
...
if TextMsg == 'الرابط' then
Redis:del(AZZF.."Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم تعطيل الرابط *","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(AZZF.."Status:Welcome"..msg_chat_id) 
...
Redis:del(AZZF.."Status:Id"..msg_chat_id) 
...
Redis:del(AZZF.."Status:IdPhoto"..msg_chat_id) 
...
Redis:del(AZZF.."Status:Reply"..msg_chat_id) 
...
Redis:del(AZZF.."Status:ReplySudo"..msg_chat_id) 
...
Redis:del(AZZF.."Status:BanId"..msg_chat_id) 
...
local EHABa = LuaTele.searchPublicChat(UserName)
if not EHABa.id then
return LuaTele.sendText(msg_chat_id,msg_id,"\n ✧ عذرا لا يوجد حساب بهاذا المعرف ","md",true)  
end
if EHABa.type.is_channel == true then
...
if Controller(msg_chat_id,EHABa.id) == 'المطور الاساسي' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✧ عذرا لا تستطيع استخدام الامر على〘 "..Controller(msg_chat_id,EHABa.id).." 〙*","md",true)  
end
if StatusCanOrNotCan(msg_chat_id,EHABa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✧ عذرا لا تستطيع استخدام الامر على〘 "..Controller(msg_chat_id,EHABa.id).." 〙*","md",true)  
end
if Redis:sismember(AZZF.."BanAll:Groups",EHABa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(EHABa.id," ✧ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."BanAll:Groups",EHABa.id) 
LuaTele.setChatMemberStatus(msg.chat_id,EHABa.id,'EHABned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(EHABa.id," ✧ تم حظره عام من المجموعات ").Reply,"md",true)  
end
end
...
if not Redis:sismember(AZZF.."BanAll:Groups",EHABa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(EHABa.id," ✧ تم الغاء حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:srem(AZZF.."BanAll:Groups",EHABa.id) 
LuaTele.setChatMemberStatus(msg.chat_id,EHABa.id,'restricted',{1,1,1,1,1,1,1,1,1})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(EHABa.id," ✧ تم الغاء حظره عام من المجموعات  ").Reply,"md",true)  
end
end
...
if Redis:sismember(AZZF.."ktmAll:Groups",EHABa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(EHABa.id," ✧ تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."ktmAll:Groups",EHABa.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(EHABa.id," ✧ تم كتمه عام من المجموعات ").Reply,"md",true)  
end
end
...
if not Redis:sismember(AZZF.."ktmAll:Groups",EHABa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(EHABa.id," ✧ تم الغاء كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:srem(AZZF.."ktmAll:Groups",EHABa.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(EHABa.id," ✧ تم الغاء كتمه عام من المجموعات  ").Reply,"md",true)  
end
end
...
if GetInfoBot(msg).EHABUser == false then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ البوت ليس لديه صلاحيه حظر المستخدمين* ',"md",true)  
end
if not msg.Originators and not Redis:get(AZZF.."Status:EHABId"..msg_chat_id) then
...
if Redis:sismember(AZZF.."EHABGroup:Group"..msg_chat_id,EHABa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(EHABa.id," ✧ تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."EHABGroup:Group"..msg_chat_id,EHABa.id) 
LuaTele.setChatMemberStatus(msg.chat_id,EHABa.id,'EHABned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(EHABa.id," ✧ تم حظره من الجروب ").Reply,"md",true)  
end
end
...
if not Redis:sismember(AZZF.."EHABGroup:Group"..msg_chat_id,EHABa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(EHABa.id," ✧ تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(AZZF.."EHABGroup:Group"..msg_chat_id,EHABa.id) 
LuaTele.setChatMemberStatus(msg.chat_id,EHABa.id,'restricted',{1,1,1,1,1,1,1,1,1})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(EHABa.id," ✧ تم الغاء حظره من الجروب  ").Reply,"md",true)  
end
end
...
if StatusSilent(msg_chat_id,EHABa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✧ عذرا لا تستطيع استخدام الامر على〘 "..Controller(msg_chat_id,EHABa.id).." 〙*","md",true)  
end
if Redis:sismember(AZZF.."SilentGroup:Group"..msg_chat_id,EHABa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(EHABa.id," ✧ تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."SilentGroup:Group"..msg_chat_id,EHABa.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(EHABa.id," ✧ تم كتمه في الجروب  ").Reply,"md",true)  
end
end
...
if not Redis:sismember(AZZF.."SilentGroup:Group"..msg_chat_id,EHABa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(EHABa.id," ✧ تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(AZZF.."SilentGroup:Group"..msg_chat_id,EHABa.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(EHABa.id," ✧ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
local EHABa = LuaTele.searchPublicChat(UserName[3])
if not EHABa.id then
return LuaTele.sendText(msg_chat_id,msg_id,"\n ✧ عذرا لا يوجد حساب بهاذا المعرف ","md",true)  
end
if EHABa.type.is_channel == true then
...
LuaTele.setChatMemberStatus(msg.chat_id,EHABa.id,'restricted',{1,0,0,0,0,0,0,0,0,tonumber(msg.date+Time)})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(EHABa.id," ✧ تم تقييده في الجروب \n ✧ لمدة : "..UserName[1]..' '..UserName[2]).Reply,"md",true)  
end
...
local EHAB = LuaTele.getUser(UserId[3])
if EHAB.luatele == "error" and EHAB.code == 6 then
return LuaTele.sendText(msg_chat_id,msg_id,"\n ✧ عذرا لا تستطيع استخدام ايدي خطأ ","md",true)  
end
...
LuaTele.setChatMemberStatus(msg.chat_id,EHABa.id,'restricted',{1,0,0,0,0,0,0,0,0})
if EHAB.first_name then
EHABiusername = '*المستخدم -› *['..EHABa.first_name..'](tg://user?id='..EHABa.id..' 〙*\n ✧ تم تقييده في الجروب\nمن قبل -› *['..bain.first_name..'](tg://user?id='..bain.id..' 〙*\n*'
else
EHABiusername = 'لا يوجد'
end
keyboard = {} 
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendvideo?chat_id=" .. msg_chat_id .. "&video=https://t.me/apqiy/89&caption=".. URL.escape(EHABiusername).."&photo="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
LuaTele.setChatMemberStatus(msg.chat_id,EHABa.id,'restricted',{1,1,1,1,1,1,1,1})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(EHABa.id," ✧ تم الغاء تقييده من الجروب").Reply,"md",true)  
end
...
if not msg.Originators and not Redis:get(AZZF.."Status:BanId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"✧ تم تعطيل (الحظر : الطرد : التقييد) من قبل المدراء","md",true)
end 
local bain = LuaTele.getUser(msg.sender.user_id)
...
if text == (Redis:get(AZZF.."Name:Bot") or 'عازف').."احظرو عام" or text == (Redis:get(AZZF.."Name:Bot") or 'عازف').." حظر عام" or text == 'حظر عام' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(1)..' 〙* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if Redis:sismember(AZZF.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(AZZF.."BanAll:Groups",Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'EHABned',0)
if EHAB.first_name then
EHABiusername = '*الـعـضـو -› *['..EHAB.first_name..'](tg://user?id='..EHAB.id..' 〙*\n ✧ تـم حـظـره عـام مـن الـمـجـمـوعـات\nبـواسـطـه -› *['..bain.first_name..'](tg://user?id='..bain.id..' 〙*\n*'
else
EHABiusername = 'لا يوجد'
end
keyboard = {} 
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendvideo?chat_id=" .. msg_chat_id .. "&video=https://t.me/apqiy/105&caption=".. URL.escape(EHABiusername).."&photo="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
if text == (Redis:get(AZZF.."Name:Bot") or 'عازف').." الغاء حظر عام" or text == (Redis:get(AZZF.."Name:Bot") or 'عازف').." الغاء الحظر عام" or text == "الغاء حظر عام" or text == 'الغاء الحظر عام' and msg.reply_to_message_id ~= 0 then
if not msg.DevelopersQ then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(2)..' 〙* ',"md",true)  
end
...
if not Redis:sismember(AZZF.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(AZZF.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if text == (Redis:get(AZZF.."Name:Bot") or 'عازف').." اكتمو عام" or text == (Redis:get(AZZF.."Name:Bot") or 'عازف').." كتم عام" or text == ('كتم عام') and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(1)..' 〙* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if Redis:sismember(AZZF.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(AZZF.."ktmAll:Groups",Message_Reply.sender.user_id) 
if EHAB.first_name then
...
if text == (Redis:get(AZZF.."Name:Bot") or 'عازف').." الغاء الكتم العام" or text == (Redis:get(AZZF.."Name:Bot") or 'عازف').."الغاء كتم العام" or text == 'الغاء كتم العام' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(1)..' 〙* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if not Redis:sismember(AZZF.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(AZZF.."ktmAll:Groups",Message_Reply.sender.user_id) 
...
if text == (Redis:get(AZZF.."Name:Bot") or 'عازف').." احظرو" or text == (Redis:get(AZZF.."Name:Bot") or 'عازف').."حظر" or text == 'حظر' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if Redis:sismember(AZZF.."EHABGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(AZZF.."EHABGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'EHABned',0)
if EHAB.first_name then
...
if text == (Redis:get(AZZF.."Name:Bot") or 'عازف').." الغاء الحظر" or text == (Redis:get(AZZF.."Name:Bot") or 'عازف').." الغاء حظر" or text == 'الغاء حظر' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if not Redis:sismember(AZZF.."EHABGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(AZZF.."EHABGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if text == (Redis:get(AZZF.."Name:Bot") or 'عازف').." اكتمو" or text == (Redis:get(AZZF.."Name:Bot") or 'عازف').." كتم" or text == 'كتم' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if Redis:sismember(AZZF.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(AZZF.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
if EHAB.first_name then
EHABiusername = '*الـعـضـو -› *['..EHAB.first_name..'](tg://user?id='..EHAB.id..' 〙*\nتـم كـتـمـه فـي الـجـروب\nبـواسـطـه -› *['..bain.first_name..'](tg://user?id='..bain.id..' 〙*\n*'
else
EHABiusername = 'لا يوجد'
...
if text == (Redis:get(AZZF.."Name:Bot") or 'عازف').." الغاء الكتم" or text == (Redis:get(AZZF.."Name:Bot") or 'عازف').." الغاء كتم" or text == 'الغاء كتم' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if not Redis:sismember(AZZF.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(AZZF.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end

if text == (Redis:get(AZZF.."Name:Bot") or 'عازف').." تقيد" or text == (Redis:get(AZZF.."Name:Bot") or 'عازف').." تقييد" or text == 'تقييد' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendvideo?chat_id=" .. msg_chat_id .. "&video=https://t.me/apqiy/104&caption=".. URL.escape(EHABiusername).."&photo="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == (Redis:get(AZZF.."Name:Bot") or 'عازف').."الغاء التقيد" or text == (Redis:get(AZZF.."Name:Bot") or 'عازف').." الغاء التقييد" or text == 'الغاء التقييد' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if text == (Redis:get(AZZF.."Name:Bot") or 'عازف').." اطرد ده" or text == (Redis:get(AZZF.."Name:Bot") or 'عازف').." طرد" or text == 'طرد' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if UserId == "1913864214" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✧ عذرا لا تستطيع استخدام الامر على المطور عازف *","md",true)  
end
if Redis:sismember(AZZF.."BanAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✧ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."BanAll:Groups",UserId) 
...
if Redis:sismember(AZZF.."BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✧ تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
if ban.first_name then
baniusername = '*الـعـضـو -› *['..ban.first_name..'](tg://user?id='..ban.id..')*\n✧ تـم حـظـره مـن الـجـروب \nبـواسـطـه -› *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
...
if not Redis:sismember(AZZF.."BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✧ تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(AZZF.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(AZZF.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✧ تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(AZZF.."SilentGroup:Group"..msg_chat_id,UserId) 
if ban.first_name then
baniusername = '*الـعـضـو -› *['..ban.first_name..'](tg://user?id='..ban.id..')*\n✧ تـم كـتـمـه فـي الـجـروب\nبـواسـطـه -› *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
baniusername = 'لا يوجد'
...
if not Redis:sismember(AZZF.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✧ تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(AZZF.."SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✧ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if text == "نزلني" then
if not Redis:get(AZZF.."Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(AZZF.."DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(AZZF.."Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(AZZF.."TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(AZZF.."TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(AZZF.."Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(AZZF.."Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(AZZF.."Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(AZZF.."Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(AZZF.."Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(AZZF.."Distinguished:Group"..msg_chat_id, msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id," ✧ تم تنزيلك من الادمنيه والمميزين ","md",true) 
end
end

if text == "اطردني" or text == "طردني" then
if not Redis:get(AZZF.."Status:KickMe"..msg_chat_id) then
...
local EHAB = LuaTele.getUser(v.member_id.user_id)
if EHAB.username ~= "" then
listAdmin = listAdmin.."*"..k.." - @SOURCE_AZZF"..Creator.."\n"
else
listAdmin = listAdmin.."*"..k.." - *["..EHAB.id.."](tg://user?id="..EHAB.id..") "..Creator.."\n"
end
end
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(AZZF.."TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(AZZF.."Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
local photo = LuaTele.getUserProfileَِphotos( EHAB.id)
...
if EHAB.username then
Creator = "* "..EHAB.first_name.."*\n"
else
Creator = "* ["..EHAB.first_name.."](tg://user?id="..EHAB.id..")*\n"
end
if EHAB.first_name then
Creat = " "..EHAB.first_name.." "
else
Creat = " Developers Bot \n"
end
if photo.total_count > 0 then
local TestText = "*𓄼• ِٰ𝗢ِٰ𝗪ِٰ𝗡ِٰ𝗘ِٰ𝗥ِٰ  ِٰ𝗚ِٰ𝗥ِٰ𝗢ِٰ𝗨ِٰ𝗣ِٰ𝗦ِٰ  -› *  ["..EHAB.first_name.."](tg://user?id="..EHAB.id..")\n*𓄼• ႦٍََِᎥَُِِ᥆ٍّ -› * [〘 "..Bio.." 〙]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = Creat, url = "https://t.me/"..EHAB.username..""},
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.َِphotos[1].sizes[#photo.َِphotos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
else
local TestText = "*𓄼• ِٰ𝗢ِٰ𝗪ِٰ𝗡ِٰ𝗘ِٰ𝗥ِٰ  ِٰ𝗚ِٰ𝗥ِٰ𝗢ِٰ𝗨ِٰ𝗣ِٰ𝗦ِٰ  -› *  ["..EHAB.first_name.."](tg://user?id="..EHAB.id..")\n*𓄼• ႦٍََِᎥَُِِ᥆ٍّ -› * [〘 "..Bio.." 〙]"
local msg_id = msg.id/2097152/0.5 
...
local  EHAB = LuaTele.getUser(Sudo_Id) 
local  bain = LuaTele.getUserFullInfo(Sudo_Id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
...
local photo = LuaTele.getUserProfileَِphotos(Sudo_Id)
if photo.total_count > 0 then
local TestText = "*𓄼•َِժٍَِᥱٓ᥎ٍَِᥱَِٓᥣًٍَِ᥆ٍَِّρََِٰᥱٓᖇٍ Ⴆٍََِ᥆ٍّƚٍَ•𓄹*\n*𓄼• ꪀَِّّᥲ️َٰꪔَِᥱٓ -› *  ["..EHAB.first_name.."](tg://user?id="..Sudo_Id..")\n*𓄼• ႦٍََِᎥَُِِ᥆ٍّ -› * ["..Bio.." ]\n"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = Creat, url = "https://t.me/"..EHAB.username..""},
...
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.َِphotos[1].sizes[#photo.َِphotos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
else
local TestText = "*𓄼•َِժٍَِᥱٓ᥎ٍَِᥱَِٓᥣًٍَِ᥆ٍَِّρََِٰᥱٓᖇٍ Ⴆٍََِ᥆ٍّƚٍَ•𓄹*\n*𓄼• ꪀَِّّᥲ️َٰꪔَِᥱٓ -› *  ["..EHAB.first_name.."](tg://user?id="..Sudo_Id..")\n*𓄼• ႦٍََِᎥَُِِ᥆ٍّ -› * ["..Bio.." ]\n"
local msg_id = msg.id/2097152/0.5 
...
local id = Redis:get(AZZF.."id:EHAB:Groups")
urrl = https.request('http://api.telegram.org/bot'..Token..'/getchat?chat_id='..id)
local EHAByt = JSON.decode(urrl)
local bains = LuaTele.getUser(EHAByt)
local name = ' '..EHAByt.result.first_name..' '
if EHAByt.result.username then
apapiy = ' '..EHAByt.result.username..' '
else
apapiy = 'SOURCE_AZZF'
end
if EHAByt.result.first_name then
klajq = ' '..EHAByt.result.first_name..' '
else
klajq = 'لا يوجد'
end
local abnj = " \n*𓄼• ꪀَِّّᥲ️َٰꪔَِᥱٓ -› * "..EHAByt.result.first_name.." \n"
keyEHAByt = {} 
keyEHAByt.inline_keyboard = {
{
{text = name, url = "https://t.me/"..EHAByt.result.username..""},
},
}
local msg_id = msg.id/2097152/0.5 
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id="..msg.chat_id.."&reply_to_message_id="..msg_id.."&photo=t.me/"..EHAByt.result.username.."&caption="..URL.escape(abnj).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyEHAByt))
local TestT = " \n*𓄼• ꪀَِّّᥲ️َٰꪔَِᥱٓ -› * "..EHAByt.result.first_name.." \n"
keyboardd = {} 
keyEHAByt.inline_keyboard = {
{
...
local EHAB = LuaTele.getUser(v.member_id.user_id)
if EHAB.username ~= "" then
restricted = restricted.."*"..x.." - @"..EHAB.username.."*\n"
else
restricted = restricted.."*"..x.." - *["..EHAB.id.."](tg://user?id="..EHAB.id..") \n"
end
end
end
if y == true then
...
local zwgat_list = Redis:smembers(AZZF..msg_chat_id.."zwgat:")
...
local mutlqat_list = Redis:smembers(AZZF..msg_chat_id.."mutlqat:")
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(AZZF.."chadmin"..msg_chat_id),"md",true)  
end
if text == "اضف قناه" then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
Redis:set(AZZF.."addchannel"..msg.sender.user_id,"on") 
...
Redis:set(AZZF.."Lock:channell"..msg_chat_id,true) 
...
Redis:set(AZZF.."Lock:text"..msg_chat_id,true) 
...
Redis:set(AZZF.."Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(AZZF.."Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(AZZF.."Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(AZZF.."Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(AZZF.."Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(AZZF.."lockalllll"..msg_chat_id,"off")
...
Redis:set(AZZF.."lockalllll"..msg_chat_id,"on")
...
Redis:set(AZZF.."lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(AZZF.."Lock:edit"..msg_chat_id,true) 
...
Redis:set(AZZF.."Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(AZZF..'close'..lock..msg_chat_id,"del")    
end
...
Redis:del(AZZF.."Lock:AddMempar"..msg_chat_id)  
...
Redis:del(AZZF.."Lock:channell"..msg_chat_id)  
...
Redis:hset(AZZF.."Spam:Group:User"..msg_chat_id ,"Num:Spam" ,Num) 
...
Redis:del(AZZF.."Lock:text"..msg_chat_id)  
...
Redis:del(AZZF.."Lock:Join"..msg_chat_id)  
...
Redis:del(AZZF.."Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(AZZF.."Lock:tagservr"..msg_chat_id)  
...
Redis:del(AZZF.."lockpin"..msg_chat_id)  
...
Redis:del(AZZF.."Lock:edit"..msg_chat_id) 
...
Redis:del(AZZF.."Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(AZZF..'Open'..lock..msg_chat_id)    
end
...
Redis:hset(AZZF.."Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(AZZF.."Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(AZZF.."Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(AZZF.."Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(AZZF.."Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(AZZF.."Lock:Link"..msg_chat_id,"del")  
...
Redis:set(AZZF.."Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(AZZF.."Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(AZZF.."Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(AZZF.."Lock:Link"..msg_chat_id)  
...
Redis:set(AZZF.."Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(AZZF.."Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(AZZF.."Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(AZZF.."Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(AZZF.."Lock:User:Name"..msg_chat_id)  
...
Redis:set(AZZF.."Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(AZZF.."Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(AZZF.."Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(AZZF.."Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(AZZF.."Lock:hashtak"..msg_chat_id)  
...
Redis:set(AZZF.."Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(AZZF.."Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(AZZF.."Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(AZZF.."Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:set(AZZF..'lock:Fshar'..msg.chat_id,true) 
...
Redis:set(AZZF..'lock:Cht'..msg.chat_id,true) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," ✧ تم قفـل السب").Lock,"md",true)  
end
...
Redis:set(AZZF..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(AZZF..'lock:Fshar'..msg.chat_id) 
...
Redis:del(AZZF..'lock:Cht'..msg.chat_id) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," ✧ تم فتح السب").unLock,"md",true)  
end
...
Redis:del(AZZF..'lock:Fars'..msg.chat_id) 
...
Redis:del(AZZF.."Lock:Cmd"..msg_chat_id)  
...
Redis:set(AZZF.."Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(AZZF.."Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(AZZF.."Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(AZZF.."Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(AZZF.."Lock:Photo"..msg_chat_id)  
...
Redis:set(AZZF.."Lock:Video"..msg_chat_id,"del")  
...
Redis:set(AZZF.."Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(AZZF.."Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(AZZF.."Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(AZZF.."Lock:Video"..msg_chat_id)  
...
Redis:set(AZZF.."Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(AZZF.."Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(AZZF.."Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(AZZF.."Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(AZZF.."Lock:Animation"..msg_chat_id)  
...
Redis:set(AZZF.."Lock:geam"..msg_chat_id,"del")  
...
Redis:set(AZZF.."Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(AZZF.."Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(AZZF.."Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(AZZF.."Lock:geam"..msg_chat_id)  
...
Redis:set(AZZF.."Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(AZZF.."Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(AZZF.."Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(AZZF.."Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(AZZF.."Lock:Audio"..msg_chat_id)  
...
Redis:set(AZZF.."Lock:vico"..msg_chat_id,"del")  
...
Redis:set(AZZF.."Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(AZZF.."Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(AZZF.."Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(AZZF.."Lock:vico"..msg_chat_id)  
...
Redis:set(AZZF.."Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(AZZF.."Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(AZZF.."Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(AZZF.."Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(AZZF.."Lock:Keyboard"..msg_chat_id)  
...
Redis:set(AZZF.."Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(AZZF.."Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(AZZF.."Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(AZZF.."Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(AZZF.."Lock:Sticker"..msg_chat_id)  
...
Redis:set(AZZF.."Lock:forward"..msg_chat_id,"del")  
...
Redis:set(AZZF.."Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(AZZF.."Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(AZZF.."Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(AZZF.."Lock:forward"..msg_chat_id)  
...
Redis:set(AZZF.."Lock:Document"..msg_chat_id,"del")  
...
Redis:set(AZZF.."Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(AZZF.."Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(AZZF.."Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(AZZF.."Lock:Document"..msg_chat_id)  
...
Redis:set(AZZF.."Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(AZZF.."Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(AZZF.."Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(AZZF.."Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(AZZF.."Lock:Unsupported"..msg_chat_id)  
...
Redis:set(AZZF.."Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(AZZF.."Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(AZZF.."Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(AZZF.."Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(AZZF.."Lock:Markdaun"..msg_chat_id)  
...
Redis:set(AZZF.."Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(AZZF.."Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(AZZF.."Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(AZZF.."Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(AZZF.."Lock:Contact"..msg_chat_id)  
...
Redis:set(AZZF.."Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(AZZF.."Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(AZZF.."Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(AZZF.."Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(AZZF.."Lock:Spam"..msg_chat_id)  
...
Redis:set(AZZF.."Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(AZZF.."Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(AZZF.."Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(AZZF.."Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(AZZF.."Lock:Inlen"..msg_chat_id)  
...
Redis:setex(AZZF.."Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:setex(AZZF.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(AZZF.."Status:Welcome"..msg_chat_id) then
...
Redis:del(AZZF.."Welcome:Group"..msg_chat_id) 
...
Redis:setex(AZZF.."Set:Rules" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(AZZF.."Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id," ✧ تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(AZZF.."Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(AZZF.."Set:Description" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(AZZF.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(AZZF.."List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(AZZF.."Filter:Group"..v..msg_chat_id)  
Redis:srem(AZZF.."List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(AZZF.."Filter:Group"..v..msg_chat_id)   
...
Redis:set(AZZF..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(AZZF..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(AZZF.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(AZZF.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(AZZF.."All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(AZZF.."All:Get:Reides:Commands:Group"..v)
Redis:del(AZZF.."All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(AZZF.."All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(AZZF.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id," ✧ الان ارسل لي الامر القديم ...","md",true)
end
...
Redis:set(AZZF.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id," ✧ ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(AZZF.."Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(AZZF.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(AZZF.."Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(AZZF.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ⇦ 〘 "..Commands.." 〙\n"
else
Command = Command..""..k..": ("..v..") \n"
...
{
{text = 'تعطيل ردود السورس', data = IdUser..'/'.. 'AZZF_sasa'},{text = 'تفعيل ردود السورس', data = IdUser..'/'.. 'Sasa_alone'},
},
{
...
if Redis:get(AZZF.."Status:Link"..msg.chat_id) then
Statuslink = '【 ✅ 】' else Statuslink = '【 ❌ 】'
end
if Redis:get(AZZF.."Status:Welcome"..msg.chat_id) then
StatusWelcome = '【 ✅ 】' else StatusWelcome = '【 ❌ 】'
end
if Redis:get(AZZF.."Status:Id"..msg.chat_id) then
StatusId = '【 ✅ 】' else StatusId = '【 ❌ 】'
end
if Redis:get(AZZF.."Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '【 ✅ 】' else StatusIdPhoto = '【 ❌ 】'
end
if Redis:get(AZZF.."Status:Reply"..msg.chat_id) then
StatusReply = '【 ✅ 】' else StatusReply = '【 ❌ 】'
end
if Redis:get(AZZF.."Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '【 ✅ 】' else StatusReplySudo = '【 ❌ 】'
end
if Redis:get(AZZF.."Status:EHAB"..msg.chat_id)  then
StatusEHABId = '【 ✅ 】' else StatusEHABId = '【 ❌ 】'
end
if Redis:get(AZZF.."Status:SetId"..msg.chat_id) then
StatusSetId = '【 ✅ 】' else StatusSetId = '【 ❌ 】'
end
if Redis:get(AZZF.."Status:Games"..msg.chat_id) then
StatusGames = '【 ✅ 】' else StatusGames = '【 ❌ 】'
end
if Redis:get(AZZF.."Status:KickMe"..msg.chat_id) then
Statuskickme = '【 ✅ 】' else Statuskickme = '【 ❌ 】'
end
if Redis:get(AZZF.."Status:AddMe"..msg.chat_id) then
...
data = {
{
{text = '𓄼•َٰ𝙎ُِ𝙊ِّ𝙐ٓ𝙍ٍّ𝘾ٍ𝙀 َٰ𝘼ًٍ𝙕ًٍ𝙕ٍ𝙁•𓄹', url = 't.me/SOURCE_AZZF'}, 
},
}
}
...
Rink = 1
elseif Redis:sismember(AZZF.."DevelopersQ:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(AZZF.."Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 3
elseif Redis:sismember(AZZF.."TheBasicsQ:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(AZZF.."TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(AZZF.."Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(AZZF.."Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
elseif Redis:sismember(AZZF.."Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 8
elseif Redis:sismember(AZZF.."Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
if Redis:sismember(AZZF.."DevelopersQ:Groups",bana.id) then
devQ = "المطور الثانوي ✧" 
else 
devQ = "" 
end
if Redis:sismember(AZZF.."Developers:Groups",bana.id) then
dev = "المطور ✧" 
else 
dev = "" 
end
if Redis:sismember(AZZF.."TheBasicsQ:Group"..msg_chat_id, bana.id) then
crrQ = "المالك ✧" 
else 
crrQ = "" 
end
if Redis:sismember(AZZF.."TheBasics:Group"..msg_chat_id, bana.id) then
crr = "منشئ اساسي ✧" 
else 
crr = "" 
end
if Redis:sismember(AZZF..'Originators:Group'..msg_chat_id, bana.id) then
cr = "منشئ ✧" 
else 
cr = "" 
end
if Redis:sismember(AZZF..'Managers:Group'..msg_chat_id, bana.id) then
own = "مدير ✧" 
else 
own = "" 
end
if Redis:sismember(AZZF..'Addictive:Group'..msg_chat_id, bana.id) then
mod = "ادمن ✧" 
else 
mod = "" 
end
if Redis:sismember(AZZF..'Distinguished:Group'..msg_chat_id, bana.id) then
vip = "مميز ✧" 
else 
vip = ""
end
...
Rink = 1
elseif Redis:sismember(AZZF.."DevelopersQ:Groups",bana.id)  then
Rink = 2
elseif Redis:sismember(AZZF.."Developers:Groups",bana.id)  then
Rink = 3
elseif Redis:sismember(AZZF.."TheBasicsQ:Group"..msg_chat_id, bana.id) then
Rink = 4
elseif Redis:sismember(AZZF.."TheBasics:Group"..msg_chat_id, bana.id) then
Rink = 5
elseif Redis:sismember(AZZF.."Originators:Group"..msg_chat_id, bana.id) then
Rink = 6
elseif Redis:sismember(AZZF.."Managers:Group"..msg_chat_id, bana.id) then
Rink = 7
elseif Redis:sismember(AZZF.."Addictive:Group"..msg_chat_id, bana.id) then
Rink = 8
elseif Redis:sismember(AZZF.."Distinguished:Group"..msg_chat_id, bana.id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(AZZF.."DevelopersQ:Groups",bana.id)
Redis:srem(AZZF.."Developers:Groups",bana.id)
Redis:srem(AZZF.."TheBasicsQ:Group"..msg_chat_id, bana.id)
Redis:srem(AZZF.."TheBasics:Group"..msg_chat_id, bana.id)
Redis:srem(AZZF.."Originators:Group"..msg_chat_id, bana.id)
Redis:srem(AZZF.."Managers:Group"..msg_chat_id, bana.id)
Redis:srem(AZZF.."Addictive:Group"..msg_chat_id, bana.id)
Redis:srem(AZZF.."Distinguished:Group"..msg_chat_id, bana.id)
elseif msg.DevelopersQ then
if Rink == 2 or Rink < 2 then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*✧ لا يمكن تنزيل رتبه نفس رتبتك ولا اعلى من رتبتك *","md",true)  
end
...
Redis:del(AZZF..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'* ✧ تم مسح جميع رسائلك *',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(AZZF..'Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'* ✧ تم مسح جميع تعديلاتك *',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(AZZF..'Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'* ✧ تم مسح جميع جهاتك المضافه *',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'* ✧ عدد رسائلك هنا ⇦ '..(Redis:get(AZZF..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'* ✧ عدد التعديلات هنا ⇦ '..(Redis:get(AZZF..'Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'* ✧ عدد جهاتك يبشا ⇦ '..(Redis:get(AZZF.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 1)..'*',"md",true)  
...
Redis:setex(AZZF.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ✧ ارسل الان النص
 ✧ يمكنك اضافه :
 ✧ `#َِυَِ᥉ََِᥱٓᖇٍꪀَِّّᥲ️َٰꪔَِᥱٓ` ‹- اسم المستخدم
 ✧ `#ꪔَِ᥉ََᧁَِᥱٓ` ‹- عدد الرسائل
 ✧ `#َِphotos` ‹- عدد الصور
 ✧ `#id` ‹- ايدي المستخدم
 ✧ `#auto` ‹- نسبة التفاعل
 ✧ `#stast` ‹- رتبة المستخدم 
...
Redis:setex(AZZF.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ✧ ارسل الان النص
 ✧ يمكنك اضافه :
 ✧ `#َِυَِ᥉ََِᥱٓᖇٍꪀَِّّᥲ️َٰꪔَِᥱٓ` ‹- اسم المستخدم
...
Redis:del(AZZF.."Set:Id:Group"..msg.chat_id)
...
Redis:del(AZZF.."DevelopersQ:Groups") 
...
Redis:del(AZZF.."Developers:Groups") 
...
Redis:del(AZZF.."TheBasics:Group"..msg_chat_id) 
...
Redis:del(AZZF.."Originators:Group"..msg_chat_id) 
...
Redis:del(AZZF.."Managers:Group"..msg_chat_id) 
...
Redis:del(AZZF.."Addictive:Group"..msg_chat_id) 
...
Redis:del(AZZF.."Distinguished:Group"..msg_chat_id) 
...
Redis:del(AZZF.."EHAB:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(AZZF.."AZZFa:Ahmed"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id," ✧ لا يوجد مطردين في المجموعه ","md",true)  
end
Redis:del(AZZF.."AZZFa:Ahmed"..msg_chat_id) 
...
Redis:del(AZZF.."SilentGroup:Group"..msg_chat_id) 
...
local Info_Members = LuaTele.getSupergroupMembers(msg_chat_id, "EHABned", "*", 0, 200)
x = 0
local List_Members = Info_Members.members
for k, v in pairs(List_Members) do
UNEHAB_Bots = LuaTele.setChatMemberStatus(msg.chat_id,v.member_id.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
if UNEHAB_Bots.luatele == "ok" then
x = x + 1
end
end
...
for k, v in pairs(List_Members) do
local EHAB = LuaTele.getUser(v.member_id.user_id)
if EHAB.type.luatele == "userTypeDeleted" then
local userTypeDeleted = LuaTele.setChatMemberStatus(msg.chat_id,v.member_id.user_id,'EHABned',0)
...
local list = Redis:smembers(AZZF.."List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(AZZF.."Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(AZZF.."Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(AZZF.."Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(AZZF.."Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(AZZF.."Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(AZZF.."Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(AZZF.."Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(AZZF.."Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(AZZF.."Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(AZZF.."List:Manager"..msg_chat_id)
end
...
text = " ✧ قائمه الردود ⇧⇩\n⩹┉┉┉┉⊶❲𖥳 َٰ𝙎ُِ𝙊ِّ𝙐ٓ𝙍ٍّ𝘾ٍ𝙀 َٰ𝘼ًٍ𝙕ًٍ𝙕ٍ𝙁 𖥳❳⊷┉┉┉┉⩺\n"
for k,v in pairs(list) do
if Redis:get(AZZF.."Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(AZZF.."Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(AZZF.."Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(AZZF.."Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(AZZF.."Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(AZZF.."Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(AZZF.."Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف 📩 "
elseif Redis:get(AZZF.."Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(AZZF.."Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." -›〘 "..v.." 〙-›〘 "..db.." 〙\n"
end
...
Redis:set(AZZF.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(AZZF.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
return LuaTele.sendText(msg_chat_id,msg_id," ✧ ارسل الان الكلمه لحذفها من الردود","md",true)  
end
if text and not Redis:sismember(AZZF.."Spam:Group"..msg.sender.user_id,text) then
Redis:del(AZZF.."Spam:Group"..msg.sender.user_id) 
end
...
local list = Redis:smembers(AZZF.."List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(AZZF.."Add:Rd:Sudo:Gif"..v)   
Redis:del(AZZF.."Add:Rd:Sudo:vico"..v)   
Redis:del(AZZF.."Add:Rd:Sudo:stekr"..v)     
Redis:del(AZZF.."Add:Rd:Sudo:Text"..v)   
Redis:del(AZZF.."Add:Rd:Sudo:Photoc"..v)
Redis:del(AZZF.."Add:Rd:Sudo:Photo"..v)
Redis:del(AZZF.."Add:Rd:Sudo:Video"..v)
Redis:del(AZZF.."Add:Rd:Sudo:File"..v)
Redis:del(AZZF.."Add:Rd:Sudo:Audio"..v)
Redis:del(AZZF.."Add:Rd:Sudo:video_note"..v)
Redis:del(AZZF.."List:Rd:Sudo")
end
...
text = "\n✧ قائمة الردود العامه ⇧⇩\n⩹┉┉┉┉⊶❲𖥳 𝐒𝐀??𝐃𝐈 𖥳❳⊷┉┉┉┉⩺\n"
for k,v in pairs(list) do
if Redis:get(AZZF.."Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(AZZF.."Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(AZZF.."Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(AZZF.."Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(AZZF.."Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(AZZF.."Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(AZZF.."Add:Rd:Sudo:File"..v) then
db = "ملف 📩 "
elseif Redis:get(AZZF.."Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(AZZF.."Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." -›〘 "..v.." 〙-›〘 "..db.." 〙\n"
end
...
Redis:set(AZZF.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(AZZF.."Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
if not msg.ControllerBot and not Redis:set(AZZF.."SendBcBot") then
...
Redis:setex(AZZF.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(AZZF.."Send:Bc:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(AZZF.."Send:Bc:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(AZZF.."Send:Fwd:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(AZZF.."Send:Fwd:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
local Added_Me = Redis:get(AZZF.."Who:Added:Me"..msg_chat_id..':'..msg.sender.user_id)
if Added_Me then 
...
if Statusrestricted(msg_chat_id,Message_Reply.sender.user_id).EHABAll == true then
EHABAll = '✧ محظور عام'
else
EHABAll = '✧ غير محظور عام'
end
if Statusrestricted(msg_chat_id,Message_Reply.sender.user_id).EHABGroup == true then
EHABGroup = '✧ محظور'
else
EHABGroup = '✧ غير محظور'
end
...
if Statusrestricted(msg_chat_id,UserId_Info.id).EHABAll == true then
EHABAll = '✧ محظور عام'
else
EHABAll = '✧ غير محظور عام'
end
if Statusrestricted(msg_chat_id,UserId_Info.id).EHABGroup == true then
EHABGroup = '✧ محظور'
else
EHABGroup = '✧ غير محظور'
end
...
if Statusrestricted(msg_chat_id,Message_Reply.sender.user_id).EHABAll == true and msg.ControllerBot then
EHABAll = '✧ محظور عام'
Redis:srem(AZZF.."EHAB:Groups",Message_Reply.sender.user_id) 
else
EHABAll = ''
end
if Statusrestricted(msg_chat_id,Message_Reply.sender.user_id).EHABGroup == true then
EHABGroup = '✧ محظور'
Redis:srem(AZZF.."EHAB:Group"..msg_chat_id,Message_Reply.sender.user_id) 
else
EHABGroup = ''
end
if Statusrestricted(msg_chat_id,Message_Reply.sender.user_id).SilentGroup == true then
...
LuaTele.sendText(msg_chat_id,msg_id,"\n* ✧ تم رفع القيود عنه -› 〘 "..EHABAll..EHABGroup..SilentGroup..Restricted..' 〙*',"md",true)  
end
...
if Statusrestricted(msg_chat_id,UserId_Info.id).EHABAll == true and msg.ControllerBot then
EHABAll = '✧ محظور عام'
Redis:srem(AZZF.."EHAB:Groups",UserId_Info.id) 
else
EHABAll = ''
end
if Statusrestricted(msg_chat_id,UserId_Info.id).EHABGroup == true then
EHABGroup = '✧ محظور'
Redis:srem(AZZF.."EHAB:Group"..msg_chat_id,UserId_Info.id) 
else
EHABGroup = ''
end
if Statusrestricted(msg_chat_id,UserId_Info.id).SilentGroup == true then
SilentGroup = '✧ مكتوم'
Redis:srem(AZZF.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
else
SilentGroup = ''
end
LuaTele.sendText(msg_chat_id,msg_id,"\n* ✧ تم رفع القيود عنه -› 〘 "..EHABAll..EHABGroup..SilentGroup..Restricted..' 〙*',"md",true)  
...
Redis:set(AZZF..'GetTexting:DevAZZF'..msg_chat_id..':'..msg.sender.user_id,true)
...
data.inline_keyboard = {
{
{text ='نسبه جمالك يا قمر '..rdbhoto..' 🌝🖤',url = "https://t.me/"..EHAB.username..""}, 
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.َِphotos[1].sizes[#photo.َِphotos[1].sizes].photo.remote.id.."&photo=".. URL.escape(rdbhoto).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(data))
end
end
if text == "صورتي" then
if Redis:get(AZZF.."Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfileَِphotos(msg.sender.user_id)
local EHAB = LuaTele.getUser(msg.sender.user_id)
local EHAB_ns = 'ʜᴇʀᴇ ᴀʀᴇ ʏᴏᴜʀ ᴘʜᴏᴛᴏѕ'
if photo.total_count > 0 then
data = {} 
data.inline_keyboard = {
{
{text = '𓄼• اخفاء الامر •𓄹', callback_data = msg.sender.user_id..'/EHAB88'}, 
},
{
{text = '▾ صورتك القادمه ▴', callback_data= msg.sender.user_id..'/EHAB1'}, 
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.َِphotos[1].sizes[#photo.َِphotos[1].sizes].photo.remote.id.."&caption=".. URL.escape(EHAB_ns).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(data))
...
{
{text = '𓄼•َٰ𝙎ُِ𝙊ِّ𝙐ٓ𝙍ٍّ𝘾ٍ𝙀 َٰ𝘼ًٍ𝙕ًٍ𝙕ٍ𝙁•𓄹', url = "http://t.me/SOURCE_AZZF"}
},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/faioo8/'..AZZF..'&caption=' .. URL.escape(EHABiusername).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'source' then
local AZZFa = (Redis:get(AZZF.."Name:Bot") or "عازف")
local user_info = LuaTele.getUser(msg.sender.user_id)
local first_name = user_info.first_name
local RinkBot = msg.Name_Controller
photo = "http://t.me/SOURCE_AZZF"
local Name = '*𓄼•َِ᭙ٍَِᥱَِٓᥣًٍَِᥴَُِ᥆ٍّꪔَِᥱٓ َِYَِِّᥲ️َٰ->* ['..RinkBot..'](tg://user?id='..user_info.id..')\n*𓄼• ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ َٰ𝙎ُِ𝙊ِّ𝙐ٓ𝙍ٍّ𝘾ٍ𝙀 َٰ𝘼ًٍ𝙕ًٍ𝙕ٍ𝙁*\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𓄼•َ𝘿ٍ𝙀ُ𝙑 َٰ𝘼 ًٍ𝙕 ًٍ𝙕 ٍ𝙁•𓄹', url = "https://t.me/X_X_A_Z_F_X_X2"}
},
{
{text = '𓄼•َ𝘿ٍ𝙀ُ𝙑 َٰ𝙎 َٰ𝘼 َٰ𝙎 َٰ𝘼•𓄹', url = "https://t.me/UUUOLC"}
},
{
{text = '𓄼•َٰ𝙎ُِ𝙊ِّ𝙐ٓ𝙍ٍّ𝘾ٍ𝙀 َٰ𝘼ًٍ𝙕ًٍ𝙕ٍ𝙁•𓄹', url = "http://t.me/SOURCE_AZZF"}
},
...
{
{text = ' اضف بوت '..AZZFa..' لمجموعتك ', url = 't.me/'..UserBot..'?startgroup=new'},
},
}
local msgg = msg_id/2097152/0.5
...
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'source' then
local timo = (Redis:get(AZZF.."Name:Bot") or "عازف")
local user_info = LuaTele.getUser(msg.sender.user_id)
local first_name = user_info.first_name
local RinkBot = msg.Name_Controller
video = "http://t.me/SOURCE_AZZF/1527"
local Name = '*𓄼•َِ᭙ٍَِᥱَِٓᥣًٍَِᥴَُِ᥆ٍّꪔَِᥱٓ َِYَِِّᥲ️َٰ->* '..RinkBot..'\n*𓄼• ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ َٰ𝙎ُِ𝙊ِّ𝙐ٓ𝙍ٍّ𝘾ٍ𝙀 َٰ𝘼ًٍ𝙕ًٍ𝙕ٍ𝙁*\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𓄼•َ𝘿ٍ𝙀ُ𝙑 َٰ𝘼 ًٍ𝙕 ًٍ𝙕 ٍ𝙁•𓄹', url = "https://t.me/X_X_A_Z_F_X_X2"}
...
{
{text = ' اضف بوت '..timo..' لمجموعتك ', url = 't.me/'..UserBot..'?startgroup=new'},
},
}
local msgg = msg_id/2097152/0.5
...
elseif text == 'عازف' or text == 'المطور عازف' or text == 'مطور السورس' then
photo = "https://t.me/A_Z_Z_F1/107"
local Name = '*المطور عازف مطور السورس لو حاابب تتواصل معاه بالاسفل ⬇️*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𓄼• َ𝘿ٍ𝙀ُ𝙑 َٰ𝘼 ًٍ𝙕 ًٍ𝙕 ٍ𝙁•𓄹', url = "https://t.me/X_X_A_Z_F_X_X2"}
...
return LuaTele.sendText(msg_chat_id,msg_id,' ✧ اليك قسم الالعاب من سورس عازف ',"md",false, false, false, false, reply_markup)
end
if Redis:get(AZZF.."zhrfa"..msg.sender.user_id) == "sendzh" then
zh = https.request('https://apiAZZF.ml/zrf.php?AZZF='..URL.escape(text)..'')
zx = JSON.decode(zh)
...
Redis:del(AZZF.."zhrfa"..msg.sender.user_id) 
end
if text == "زخرفه" or text == "زخرفة" then
LuaTele.sendText(msg_chat_id,msg_id,"* ✧ ارسل الكلمه لزخرفتها عربي او انجلش*","md",true) 
Redis:set(AZZF.."zhrfa"..msg.sender.user_id,"sendzh") 
end
if text and text:match("^زخرفه (.*)$") then
local TextZhrfa = text:match("^زخرفه (.*)$")
zh = https.request('https://apiAZZF.ml/zrf.php?AZZF='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n* ✧ قائمه الزخرفه ⇧⇩*\n*⩹┉┉┉┉⊶❲𖥳َٰ𝙎ُِ𝙊ِّ𝙐ٓ𝙍ٍّ𝘾ٍ𝙀 َٰ𝘼ًٍ𝙕ًٍ𝙕ٍ𝙁𖥳❳⊷┉┉┉┉⩺*\n* أضغط علي الاسم لا يتم النسخ ✧ *\n"
i = 0
for k,v in pairs(zx.ok) do
...
if Redis:get(AZZF.."brgi"..msg.sender.user_id) == "sendbr" then
gk = https.request('https://apiAZZF.ml/brg.php?brg='..URL.escape(text)..'')
br = JSON.decode(gk)
i = 0
...
LuaTele.sendText(msg_chat_id,msg_id,t,"md",true) 
Redis:del(AZZF.."brgi"..msg.sender.user_id) 
end
if text == "الابراج" or text == "برجي" then
LuaTele.sendText(msg_chat_id,msg_id,"* ✧ ارسل البرج الان لعرض التوقعات*","md",true) 
Redis:set(AZZF.."brgi"..msg.sender.user_id,"sendbr") 
end
if text and text:match("^برج (.*)$") then
local Textbrj = text:match("^برج (.*)$")
gk = https.request('https://apiAZZF.ml/brg.php?brg='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
for k,v in pairs(br.ok) do
i = i + 1
...
if Redis:get(AZZF.."Status:kool"..msg.chat_id) then
...
if tonumber(Message_Reply.sender.user_id) == tonumber(AZZF) then
return LuaTele.sendText(msg_chat_id,msg_id,"*شوفلك كلبه غير البوت يبنوسخه 😒*","md",true)  
end
if Redis:sismember(AZZF..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
local rd_mtzwga = {
...
if Redis:sismember(AZZF..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) then 
Redis:srem(AZZF..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
end
Redis:sadd(AZZF..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) 
...
if Redis:sismember(AZZF..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
Redis:srem(AZZF..msg_chat_id.."zwgat:",Message_Reply.sender.user_id)
Redis:sadd(AZZF..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
local rd_tmtlaq = {
...
if not Redis:get(AZZF.."EHAB:Sasa"..msg_chat_id) then
...
if text == 'سي في' or text == 'سيفي' or text == 'cv' then
if not Redis:get(AZZF.."EHAB:Sasa"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
...
echo '✧〘 نظام التشغيل 〙✧\n* '"$linux_version"'*' 
echo ' ◤┉┉┉┉⊶❲𖥳 َٰ𝙎ُِ𝙊ِّ𝙐ٓ𝙍ٍّ𝘾ٍ𝙀 َٰ𝘼ًٍ𝙕ًٍ𝙕ٍ𝙁 𖥳❳⊷┉┉┉┉◥ \n 🌐〘 الذاكره العشوائيه 〙  ⇦\n〘* '"$memUsedPrc"'*〙'
echo ' ◤┉┉┉┉⊶❲𖥳 َٰ𝙎ُِ𝙊ِّ𝙐ٓ𝙍ٍّ𝘾ٍ𝙀 َٰ𝘼ًٍ𝙕ًٍ𝙕ٍ𝙁 𖥳❳⊷┉┉┉┉◥ \n 🌐〘 وحـده الـتـخـزيـن 〙  ⇦\n〘* '"$HardDisk"'*〙'
...
Redis:setex(AZZF.."Change:Name:Bot"..msg.sender.user_id,300,true) 
...
local photo = LuaTele.getUserProfileَِphotos(AZZF)
local EHAB = LuaTele.getUser(AZZF)
local NamesBot = (Redis:get(AZZF.."Name:Bot") or "عازف")
local BotName = {
...
msgg = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.َِphotos[1].sizes[#photo.َِphotos[1].sizes].photo.remote.id.."&photo=".. URL.escape(first_n).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
if text == (Redis:get(AZZF.."Name:Bot") or "عازف") then
local photo = LuaTele.getUserProfileَِphotos(AZZF)
local EHAB = LuaTele.getUser(AZZF)
local NamesBot = (Redis:get(AZZF.."AZZF:Name:Bot") or "عازف")
local BotName = {
'نعم يروحي 🌝💙',
'نعم يا قلب '..NamesBot..'',
'عوز اي مني '..NamesBot..'',
...
if text == (Redis:get(AZZF.."Name:Bot") or 'عازف').." غادر" or text == 'غادر' or text == 'بوت غادر' then
if not msg.Developers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص 〘 '..Controller_Num(3)..' 〙* ',"md",true)  
end
if not msg.ControllerBot and not Redis:set(AZZF.."Left:EHAB:Bot") then
...
if EHAB.first_name then
EHABiusername = '*عزيزي -› *['..bain.first_name..'](tg://user?id='..bain.id..')*\nهل تريد بوت -› *['..AZZFa..'](tg://user?id='..EHAB.id..')*\nان يغادر من المجموعه\n*'
else
EHABiusername = 'لا يوجد'
end
local reply_markup = LuaTele.replyMarkup{
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,AZZF)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'* ✧ البوت عظو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(AZZF..'ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(AZZF..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(AZZF..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(AZZF..'ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(AZZF.."Game:Smile"..msg.chat_id,SM)
...
if Redis:get(AZZF.."Status:Games"..msg.chat_id) then
Redis:del(AZZF.."Set:Country"..msg.chat_id)
...
Redis:set(AZZF.."Game:Countrygof"..msg.chat_id,name)
...
Redis:set(AZZF.."Game:EHAB"..msg.chat_id,name)
...
Redis:set(AZZF.."Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(AZZF.."Status:Games"..msg.chat_id) then
Redis:del(AZZF.."Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(AZZF.."Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(AZZF.."Status:Games"..msg.chat_id) then
Redis:del(AZZF.."SetAks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(AZZF.."Gamection"..msg.chat_id,name)
...
Redis:set(AZZF.."Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(AZZF.."Game:Difference"..msg.chat_id,name)
...
Redis:set(AZZF.."Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(AZZF.."Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(AZZF.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(AZZF.."Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(AZZF.."Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(AZZF.."Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(AZZF.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(AZZF.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(AZZF.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(AZZF.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(AZZF.."Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(AZZF.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(AZZF.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(AZZF.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(AZZF.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
return LuaTele.sendText(msg_chat_id,msg_id,[[*
...
if text == '/start' then
Redis:sadd(AZZF..'Num:User:Pv',msg.sender.user_id)  
if not msg.DevelopersQ then
if not Redis:get(AZZF.."Start:Bot") then
local CmdStart = '*\n ✧ أهلا بك في بوت '..(Redis:get(AZZF.."Name:Bot") or "عازف")..
...
local abnj = " \n*𓄼• ꪀَِّّᥲ️َٰꪔَِᥱٓ -› * "..banyt.result.first_name.." \n"
keybanyt = {} 
...
Redis:setex(AZZF.."Change:Start:Bot"..msg.sender.user_id,300,true) 
...
local Info_Members = Redis:smembers(AZZF.."BanAll:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id," ✧ لا يوجد محظورين عام حاليا , ","md",true)  
end
Redis:del(AZZF.."BanAll:Groups") 
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم مسح  〘 "..#Info_Members.." 〙 من المحظورين عام *","md",true)
end
...
if not msg.ControllerBot then
if Redis:get(AZZF.."TwaslBot") and not Redis:sismember(AZZF.."EHAB:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(AZZF.."Twasl:UserId"..msg.date,172800,IdUser)
...
if data.supergroup.status.luatele == "chatMemberStatusEHABned" then
Redis:srem(AZZF.."ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(AZZF..'*'..'-100'..data.supergroup.id..'*')
Redis:del(AZZF.."List:Manager"..'-100'..data.supergroup.id)
Redis:del(AZZF.."Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(AZZF.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(AZZF.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(AZZF.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(AZZF.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(AZZF.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(AZZF.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(AZZF.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(AZZF.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(AZZF.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(AZZF.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(AZZF.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(AZZF.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(AZZF.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(AZZF.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(AZZF.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(AZZF.."PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(AZZF.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(AZZF.."PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(AZZF.."Lock:tagservr"..data.message.chat_id) then
...
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(AZZF..'Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
Redis:incr(AZZF..'Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(AZZF.."Lock:edit"..data.chat_id) then
...
Redis:del(AZZF.."Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(AZZF.."Set:array"..IdUser..":"..ChatId)
Redis:del(AZZF.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(AZZF.."Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(AZZF.."Set:array"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(AZZF.."Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id," ✧  ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(AZZF.."Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id," ✧  ارسل لي الرد الان", 'md', true)
end
end
...
Redis:incrby(AZZF.."Num:Add:Games"..ChatId..IdUser, 1)  
...
local inget = Redis:get(AZZF..'hmsabots'..ramsesadd[3]..data.sender_user_id)
...
Redis:set(AZZF..'hmsabots'..idnum..UserId_Info.id,username[1])
Redis:set(AZZF..'hmsabots'..idnum..data.sender_user_id,username[1])
end
end
end
...
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. ChatId .. '&voice=https://t.me/faioo8/'..AZZF..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. ChatId .. '&voice=https://t.me/emeuii/'..AZZF..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
end
end
...
{
{text = '𓄼• مسح المكتومين •𓄹', data = IdUser..'/SilentGroupGroup'}, {text = '𓄼• مسح المحظورين •𓄹', data = IdUser..'/EHABGroup'}, 
},
{
...
local TextHelp = [[*
• أهلا بك في قائمة العاب سورس عازف اختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
• مرحبا بك في الالعاب المتطورة الخاص بسورس عازف 
...
EHABiusername = '*تم الزواج بنجاح \nمبورك يا  -› *['..bain.first_name..'](tg://user?id='..bain.id..' 〙*\n*'
else
EHABiusername = 'لا يوجد'
end
LuaTele.editMessageText(ChatId,Msg_id,EHABiusername, 'md', true, false, reply_markup)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Link"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," ✧ تم قفـل الروابط").Lock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/lock_spam') then
local UserId = Text:match('(%d+)/lock_spam')
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(AZZF.."Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(AZZF.."Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(AZZF.."Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(AZZF.."Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Status:Link"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," ✧ تم تعطيل امر الردود العامه").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/AZZF_sasa') then
local UserId = Text:match('(%d+)/AZZF_sasa')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."EHAB:Sasa"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Status:EHAB"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," ✧ تم تفعيل امر الردود العامه").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/Sasa_alone') then
local UserId = Text:match('(%d+)/Sasa_alone')
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."EHAB:Sasa"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Status:EHAB"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(AZZF.."Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(AZZF.."TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(AZZF.."Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(AZZF.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(AZZF..'close'..lock..UserId[2],"del")    
end
...
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(AZZF..'Open'..lock..UserId[2],"del")    
end
...
{
{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =IdUser..'/'.. 'NoNextSeting'}
},
{
{text = '𓄼• القائمه الرئيسيه •𓄹 ', data = IdUser..'/helpall'},
},
...
{
{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},
},
}
}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(AZZF.."Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'Ⴆٍََِᥲ️ََِٰᥴَُِkٍ', data =UserId..'/'.. 'NoNextSeting'},},}}
...
elseif Text and Text:match('(%d+)/EHABGroup') then
local UserId = Text:match('(%d+)/EHABGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."EHAB:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"* ✧ تم مسح المحظورين *", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(AZZF.."SilentGroup:Group"..ChatId) 
